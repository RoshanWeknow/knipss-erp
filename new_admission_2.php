						...
						<div class="col-md-12">
							...
							<div class="row">
								<div class="col-md-3">							
									...
									<select name="s_class" class="form-control" id="s_class"  value="<?php if(isset($_POST['s_class'])){echo $_POST['s_class'];} ?>" onChange="get_subject(this.value)" onFocus="fnTXTFocus(this.id)" >
								...
								<div class="col-md-3">							
									<label>Batch</label>
									<input type="text" id="batch" name="batch" class="form-control"  value="<?php if(isset($_POST['batch'])){echo $_POST['batch'];} ?>">
								</div>
							</div>
							<div class="row">							
								<div class="col-md-2">
									Subject 1.&nbsp;<select name="sub1"   class="form-control"  id="sub1"  value="<?php if(isset($_POST['sub1'])){echo $_POST['sub1'];} ?>" onFocus="fnTXTFocus(this.id)"><option value=""></option></select>
								</div>
								<div class="col-md-2">
									Subject 2.&nbsp;<select name="sub2"   class="form-control"  id="sub2"  value="<?php if(isset($_POST['sub2'])){echo $_POST['sub2'];} ?>" onFocus="fnTXTFocus(this.id)"><option value=""></option></select>					
								</div>
								<div class="col-md-2">
									Subject 3.&nbsp;<select name="sub3"  class="form-control"  id="sub3"  value="<?php if(isset($_POST['sub3'])){echo $_POST['sub3'];} ?>" onFocus="fnTXTFocus(this.id)"><option value=""></option></select>
								</div>
							</div>
							<div class="row">
								<div class="col-md-2">							
									<label>Minor/Elective: <span class="alert">*</span></label>
									<select name="other_sub1"  value="" class="form-control"  id="other_sub1" onFocus="fnTXTFocus(this.id)">
								...
								<div class="col-md-2">							
									...
									<select name="other_sub1"  value="" class="form-control" id="other_sub1"  name="other_sub2"  value="" class="form-control"  id="other_sub2" onFocus="fnTXTFocus(this.id)">
								...
								<div class="col-md-2">							
									...
									<select name="other_sub3"  value="" class="form-control"  id="other_sub3" onFocus="fnTXTFocus(this.id)">
							...
							<div class="row">
								<div class="col-md-4">							
									...
									<input class="form-control"   type="text" id="tax11" maxlength="10" size="10" name="form_no" value="<?php if(isset($_POST['form_no'])){echo $_POST['form_no'];} ?>" onFocus="fnTXTFocus(this.id)" />
								</div>
							</div>
							<div class="row">
								<div class="col-md-4">							
									<label>Candidate's Full Name </label>
									<input class="form-control"  id="s_name" maxlength="45" size="40" value="<?php if(isset($_POST['s_name'])){echo $_POST['s_name'];} ?>"  name="s_name" onFocus="fnTXTFocus(this.id)" >
								</div>
							</div>
							<div class="row">							
								<div class="col-md-4">							
									<label>Father's Name</label>
									<input class="form-control"  id="f_name" maxlength="35" size="40" name="f_name" value="<?php if(isset($_POST['f_name'])){echo $_POST['f_name'];} ?>" onFocus="fnTXTFocus(this.id)" >
								</div>
							</div>
							<div class="row">
								<div class="col-md-4">							
									<label>Mother's Name </label>
									<input class="form-control"  id="m_name" maxlength="35" size="40" name="m_name"  value="<?php if(isset($_POST['m_name'])){echo $_POST['m_name'];} ?>" onFocus="fnTXTFocus(this.id)" >
								</div>
							</div>
							<div class="row">	
								<div class="col-md-4">							
							...
							<div class="row">							
								<div class="col-md-4">							
									<label>Gender</label>
									<select class="form-control"  name="gen" id="gen" value="<?php if(isset($_POST['gen'])){echo $_POST['gen'];} ?>" onFocus="fnTXTFocus(this.id)" tabindex="<?php echo $tab++; ?>">
							...
							<div class="row">
								<div class="col-md-4">							
									...
									<select class="form-control"  name="opt_cat" id="opt_cat" value="<?php if(isset($_POST['opt_cat'])){echo $_POST['opt_cat'];} ?>" onChange="changefees1(this.value)" onFocus="fnTXTFocus(this.id)" tabindex="<?php echo $tab++; ?>">
							...
							<div class="row">
								<div class="col-md-4">							
									...
									<select class="form-control"  name="opt_minor" id="opt_minor"   value="<?php if(isset($_POST['opt_minor'])){echo $_POST['opt_minor'];} ?>" onChange="changefees1(this.value)" onFocus="fnTXTFocus(this.id)" tabindex="<?php echo $tab++; ?>">
							...
							<div class="row">							
								<div class="col-md-4">							
									...
									<select name="physical_handicapped" value="" class="form-control"  tabindex="<?php echo $tab++; ?>">
							...
							<div class="row">
								<div class="col-md-4" id="prev_univ_li">							
									<label>Select Prev. University</label>
									<select name="prev_univ" class="form-control" id="prev_univ"  value="<?php if(isset($_POST['prev_univ'])){echo $_POST['prev_univ'];} ?>" onFocus="fnTXTFocus(this.id)"  tabindex="<?php echo $tab++; ?>">
										<option value=""></option>
							...
							<div class="row" id="fees_detail" style="display: none;">
								<div class="col-md-4" id="fees">							
									<label>Fees</label>
									<input class="form-control"  maxlength="15" size="20" name="fees" id="final_fees_value"  value="<?php if(isset($_POST['fees'])){echo $_POST['fees'];} ?>" onFocus="fnTXTFocus(this.id)"  tabindex="<?php echo $tab++; ?>">
								</div>
								<div class="row">							
									<div class="col-md-4">							
								...
								<div class="row">
									<div class="col-6">
										<table>
											...
											<tr>
												<td>Discount : </td>
												<td><input type="text" name="fees_discount" id="fees_discount" class="fieldtextsmall medium" onBlur="check_discount(this.value);"></td>
												<td>Final Fees :</td>
												<td id="final_fees"></td>
											</tr>
											<tr>
												<td colspan="2">Current Deposit :</td>
												<td colspan="2"><input type="text" name="fees_deposit" id="fees_deposit" class="fieldtextsmall medium" onBlur="check_deposit(this.value);"></td>
											</tr>
											<tr>
												<td colspan="2">Fix Amount :</td>
												<td colspan="2"><input type="text" name="fix_amount" id="fix_amount" class="fieldtextsmall medium" readonly></td>
											</tr>
										</table>
									</div>
									<div class="col-md-2" id="computer">							
										<label>Computer Fees</label>
										<input class=""  type="checkbox" id="tax11" maxlength="10" size="10" name="computer" onFocus="fnTXTFocus(this.id)" <?php if(isset($_POST['computer'])) echo 'checked="checked"';  ?> tabindex="<?php echo $tab++; ?>" />
									</div>
									<div class="col-md-2" id="self">							
										<label>Self Fees</label>
										<input class=""  type="checkbox" id="tax11" maxlength="10" size="10" name="self" onFocus="fnTXTFocus(this.id)" <?php if(isset($_POST['self'])) echo 'checked="checked"';  ?>  tabindex="<?php echo $tab++; ?>"/>
									</div>
									<div class="col-md-2" id="tour">							
										<label>Tour Fees</label>
										<input class=""  type="checkbox" <?php echo $tour_sel;?> id="tax11" maxlength="10" size="10" name="tour" onFocus="fnTXTFocus(this.id)" <?php if(isset($_POST['tour'])) echo 'checked="checked"';  ?>  tabindex="<?php echo $tab++; ?>"/>
									</div>
									<div class="col-md-2" id="vocational">							
										<label>Vocational Fees</label>
										<input class=""  type="checkbox" <?php echo $vocational;?> id="tax11" maxlength="10" size="10" name="vocational" onFocus="fnTXTFocus(this.id)" <?php if(isset($_POST['vocational'])) echo 'checked="checked"';  ?>  tabindex="<?php echo $tab++; ?>"/>
									</div>
								</div>
							</div>
							...
							<div class="row">
								<div class="col-md-3">							
									...
									<input type="text"class="form-control"  name="income_cert" size="15"  value="<?php if(isset($_POST['income_cert'])){echo $_POST['income_cert'];} ?>" onFocus="fnTXTFocus(this.id)" tabindex="<?php echo $tab++; ?>">
								</div>
							</div>
							<div class="row">
								<div class="col-md-3">							
									<label>Please Select Income</label>
									<select name="income" id="income" class="form-control"  tabindex="<?php echo $tab++; ?>">
							...
							<div class="row">
								<div class="col-md-3">							
									...
									<input type="text"class="form-control"  name="account_no" size="15" value="<?php if(isset($_POST['account_no'])){echo $_POST['account_no'];} ?>" onFocus="fnTXTFocus(this.id)" tabindex="<?php echo $tab++; ?>">
								</div>
							</div>
							<div class="row">
								<div class="col-md-3">							
									<label>Mobile</label>
									<input name="p_mobile"class="form-control"  id="p_mobile" size="25" maxlength="10"  value="<?php if(isset($_POST['p_mobile'])){echo $_POST['p_mobile'];} ?>" tabindex="<?php echo $tab++; ?>">
								</div>
							</div>
							<div class="row">
								<div class="col-md-6">
...
<body id="public">
	<div id="wrapper">	
        ...
        <table class="table table-striped">
        	<tr>
            	<th colspan="2">Date of Admission : <?php echo $_POST['doa']; ?><input type="hidden" name="doa" value="<?php echo $_POST['doa']; ?>"></th>
            	<?php
				if(isset($_POST['fees_discount'])){
            ...
            <tr>
				...
				if(isset($_POST['tour'])){
					echo '<th colspan="2"> Tour Fees: Rs'.$tour_fees.'</th>
					<input type="hidden" name="tour" value="'.$tour_fees.'">';
				}
				else{
				$tour_fees='';
				}?>
				<th colspan="2">Main Fees : <?php 
				if($_POST['income']>1){
					$cat="GEN";
				}
				else{
			...
			<tr>
                <th colspan="2">Total Fees :
                <?php $main_total=$comp_fees+ $self_fees+ $total+ $tour_fees+$vocational;
				 echo $main_total;?></th>
                <th colspan="2">Form Number : <?php echo $_POST['form_no']; ?><input type="hidden" name="form_no" value="<?php echo $_POST['form_no']; ?>"/></th>
                <th colspan="4">Name : <?php echo $_POST['s_name']; ?><input type="hidden" value="<?php echo $_POST['s_name']; ?>" name="s_name"></th>
			</tr>
			<tr style="background:#F00;">
                <th colspan="2">Mode of Payment :
                <select name="mode_of_payment" id="mode_of_payment">
                	<option value="cash">Cash</option>
                	<option value="cheque">Cheque</option>
                </select>
                </th>
                <th colspan="4">Cheque Number and Bank : <input type="text" name="chq_no" id="chq_no"></th>
			</tr>
			<?php
			if(isset($_POST['fees_deposit'])){
				echo '<tr><th colspan="2">Current Deposit Amount</th><th colspan="2">'.$_POST['fees_deposit'].'<input type="hidden" value="'.$_POST['fees_deposit'].'" name="fees_deposit"></th></tr>';
			}
