            ...
            <div class="col-md-12">
                <div class="card">
					...
					$limit = 50;
							...
							$offset = ($page - 1) * $limit;
							$sql = "SELECT * FROM bba_lib_id_card ORDER BY sno ASC LIMIT {$offset}, {$limit}";
					...
					// FOR PUT PAGES UPPER SIDE OF THE TABLE
						$sql1 = 'select * from bba_lib_id_card';
									...
									while($row = mysqli_fetch_assoc($result)){
										...
										echo '<tr align="center">
											...
											<td>'.$row['course'].'</td>
												...
												<td><a href="bba_lib_card_result.php?id='.$row['sno'].'" target="_blank"><i class="fa fa-print" style="font-size:20px; color:red;"></i></a></td>
											</tr>';
