...
$exam_query = "SELECT DISTINCT exam_id FROM back_exam_student_info";
...
<body>
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <h2 class="bg-primary text-white text-center p-2">EXAM STUDENT SUMMARY REPORT <button class="btn btn-warning"><a href="exam_student_report.php" target="_blank">REGULAR STUDENT REPORT</button></a></h2>
                <div class="card-body">
