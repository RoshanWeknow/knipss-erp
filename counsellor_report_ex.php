		...
		<div class="card-body ">
			<div class="row d-flex my-auto">
					<div class="col-md-12">
						...
						<form action="counsellor_report_ex.php" class="wufoo leftLabel page1" name="feesdeposit" enctype="multipart/form-data" method="post" onSubmit="" >
						<div class="row">							
							<div class="col-md-4">							
				...
				<?php
                $sql = "select * from student_info3 where counselling_date='".$_POST['apr_date']."' and user_id='".$_POST['stu_id']."'";
				if(isset($_POST['s_class'])){
					if($_POST['class']!=''){
						...
						<table width="100%" class="table table-striped table-hover rounded">
							<tr class="bg-primary text-white">
								...
								while($row = mysqli_fetch_array($result)){
									...
									$sql = "select * from fee_invoice4 where approval_date='".$_POST['apr_date']."' and student_id='".$row['sno']."' and type='fees'";
									$fees=execute_query(connect(), $sql);
									if(mysqli_num_rows($fees)!=0){
										$fees = mysqli_fetch_array($fees);
										
										$sql = "select * from fee_invoice4 where approval_date='".$_POST['apr_date']."' and student_id='".$row['sno']."' and type='self'";
										...
										$sql = "select * from fee_invoice4 where approval_date='".$_POST['apr_date']."' and student_id='".$row['sno']."' and type='computer'";
										...
										$sql = "select * from fee_invoice4 where approval_date='".$_POST['apr_date']."' and student_id='".$row['sno']."' and type='tour'";
										...
										<td>';
										if($_SESSION['username']=='sadmin'){
											echo '<a href="counsellor_report_ex.php?del='.$row['sno'].'" onclick="return confirm(\'Are you sure?\');">Delete</a>';
										}		
										echo '</td></tr>';
