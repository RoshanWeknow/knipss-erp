...
<html lang="en">
  ...
  <body>
    ...
    <div class="wrap" src="image/temp1.png" alt="bgimage">
      ...
      <span class="firstSig-sig"><img class="firstSig-sig-img" src="image/praveen_sir_sign.png" alt="Praveen-Sir-Signature"></span>
      <span class="firstSig_degis">Director,IQAC/HOD, Physical Education</span>

      <span class="secondSig">Prof. Alok Kumar Singh</span>
         <span class="secondSig-sig"><img class="secondSig-sig-img" src="image/alok_sir_sign.png" alt="Praveen-Sir-Signature"></span>
