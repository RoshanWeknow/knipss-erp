...
<html>
	...
	<body>
	<h3><a href="dcr_generate_excel.php?id=<?php echo $_GET['id']; ?>" target="_blank">Convert to Excel</a></h3>
	<div id="wrapper">
	...
	<?php
			...
			<table width="100%">
				<tr style="background:#333; color:#FFF; text-align:center; font-size:16px;">
					<td colspan="5">DCR Date : <?php echo $dcr['date_of_creation']; ?></td>
					<td colspan="5">Cash in Hand Opening : <?php echo $dcr['cash_opening']; ?></td>
					<td  colspan="5">Cash in Hand Closing : <?php echo $dcr['cash_closing']; ?></td>
				</tr>
				<tr>
