...
<?php	
    ...
    if(isset($_POST['edit']) && $_POST['edit'] != ''){
        $sql = 'UPDATE lib_master_almirah set 
			 ...
			 //echo $sql;		 
				...
				$sql = 'INSERT INTO lib_master_almirah(subject, almirah_name, quantity, tray_name, created_by, creation_time) 
	...
	if(isset($_GET['del'])){
		$sql = 'delete from lib_master_almirah where sno="'.$_GET['del'].'"';
		mysqli_query($db, $sql);
		if(mysqli_error($db)){
	...
	if(isset($_GET['edit'])){
	$sql = 'select * from lib_master_almirah where sno = '.$_GET['edit'];
