...
<html lang="en">
	<head>
		...
		<style>
			...
			/* @page {
				background-image: url("images/college_log.png");Path to your watermark image 
				background-repeat: no-repeat;
				background-size: 50%; Adjust the size of the watermark as needed
				background-position: center center;
				margin: 0; Set margin to 0 to ensure the watermark covers the entire page
			} */
							...
							<td colspan="8">
								<table  width="100%" class="table table-bordered border-dark" >
									...
									<tr>
										...
										<?php
											$sql_marks = 'Select pt_marks_max from exam_student_paper_info where practicle_allotment = "'.$_GET['id'].'"';
							...
							<td colspan="8">
								<table class="table table-bordered border-dark">
									...
									<tr align="center">
										...
										<th scope="col"  width="10%" >COLLEGE CODE</th>
									...
									$query = 'SELECT *,exam_student_paper_info.sno as id FROM `exam_student_paper_info` LEFT JOIN exam_student_info on exam_student_info_sno=exam_student_info.sno  WHERE practicle_allotment ="'.$_GET['id'].'" AND paper_code ="'.$_GET['ppr'].'" ORDER BY exam_roll_no';
									//echo $query;
								...
								<table>
									<?php
										...
										<tr style="height:20px">
											...
											<th scope="col"  width="50%" style="text-align:right;font-size:0.8rem!important;padding-right:5rem!important;" ><?php echo $row_teac_ext['name'] ;?></th>
										</tr>
										<tr style="height:20px">
										...
										<tr >
											...
											<td scope="col"  width="50%" style="text-align:right;padding-right:1rem!important;">SIGNATURE OF EXTERNAL EXAMINER</td>
										</tr>
										<tr >
