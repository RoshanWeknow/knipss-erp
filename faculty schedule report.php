		...
		<div class="card">
			<div class="card-header">
				...
				<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST" enctype="multipart/form-data" id="" name="" target="_blank">
					<?php echo $msg; ?> 
					<div class="col-md-12">
						<h2 class="bg-primary text-white p-2" style="text-align:center;">Faculty Schedule Report</h2>
						<div class="row">
							<div class="col-md-3"></div>
							<div class="col-md-6 mt-5">
								<form>
									<h3 style="text-align:center;background-color:#0d6efd;color:white;height:4rem;line-height:4rem;">EXAMINATION ATTENDANCE REPORT</h3>
									<div style="padding-left:10px;padding-right:10px;">
										...
										<div class="mb-3 me-3" style="width:100%;">
											<label for="designation" class="form-label">EXAMINATION SHIFT</label>
											<select id="designation" class="form-select">
												<option>FIRST SHIFT:MORNING</option>
												<option>SECOND SHIFT:EVENING</option>
												
											</select>
										</div>
										<div class="d-flex" style="justify-content:space-around;">
											<div class="pt-2">
												<button type="search" name = "search" value="search" class="btn btn-primary mt-2 ms-2" style="padding-left:30px;padding-right:30px;">Search</button>
											</div>
											<div  class="pt-2">
