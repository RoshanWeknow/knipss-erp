            ...
            <div class="col-md-12">
                <div class="card">
					...
					<table class="table table-striped table-hover" id="general_stat_table">
						...
						<?php
							$query = 'SELECT *,exam_student_paper_info.sno as id FROM `exam_student_paper_info` LEFT JOIN exam_student_info on exam_student_info_sno=exam_student_info.sno  WHERE mid_sem_allotment ="'.$_GET['view'].'" AND paper_code ="'.$_GET['ppr'].'" ORDER BY exam_roll_no';
							//echo $query;
