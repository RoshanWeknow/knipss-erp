...
<h3 style="font-size:20px;"><strong>Kamla Nehru Institute Of Physical & Social Sciences, Sultanpur</strong></h3><br>
<h3>Form Fee(Day Wise) Report</h3>
<?php
	...
	<tr>
		...
		$sql = $_SESSION['form_fee_day_wise'];
		//echo $sql;
              $i=1;
              $amount = 0;
              $count = 0;
