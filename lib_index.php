	...
	<div class="d-flex">
		<div class="wrap" style="border-right:0px solid black; box-shadow:0px 0px 10px black; border-radius:5px; margin:5px; width:20%;">
			<div class="person_info" style="border-bottom:1px solid black; background-color:var(--background-color); color:white; border-radius:5px;">
				...
				<div style="text-align:center; padding:5px;" class="">(kni2063)</div>
			...
			<div class="detail_col" style="padding:0px;">
				<div class="sidenav">
					...
					<div class="dropdown">
						<?php
							$parentsql="SELECT * FROM lib_navigation WHERE parent='P' ORDER BY sort_no";
											...
											<div class="dropdown-content">
												<?php
													...
													while($childrow=mysqli_fetch_assoc($childres)){
														$j++;
														?>
															<a style="color:black; font-size:1rem;" href="<?php echo $childrow['hyper_link']?>"> <?php echo $j; ?>.&nbsp;<?php echo $childrow['link_description']?></a>
														<?php
													}
												?>
											</div>
		...
		<div class="form_col" style="width:80%;">
			<table width="100%" style="border-bottom: 1px solid black;background-color: var(--background-color); color: white;border-radius: 5px;}" class=" text-white mt-1 me-2">
				<tr>
					...
					<th><button class="btn btn-danger me-2" style="">Logout</button></th>
				</tr>
			</table>
				...
				<form class=" mt-3">
					<fieldset class="">
						<div class="container">
							...
							<div class="text-center mb-3 fw-bold sub_head">PERSONAL DETAILS</div>
							<div class="container">
								<div class="row">
							...
							<div class="text-center mb-3 fw-bold ">
								<button type="reset" class="btn btn-outline-secondary col-md-3">Reset</button>
								<button type="Submit" class="btn btn-outline-secondary col-md-3">Submit</button>
							</div>
