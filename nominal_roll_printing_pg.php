...
<tr><th>S.No</th><th>FATHER/ HUSBAND NAME</th><th>STUDENT NAME</th><th>COLLEGE ROLL NO</th><th> UNIVERSITY ROLL NO</th><th>PAPER 1</th><th>PAPER 2</th><th>PAPER 3</th><th>PAPER 4</th><th>PAPER 5</th><th>PAPER 6</th>
<th colspan="3">QUALIFYING EXAMINATION DETAILS</th></tr><tr><th colspan="11">&nbsp;</th><th>ROLL NO</th><th>YEAR</th><th>TOTAL MARKS</th></tr>
</thead>
<tbody>
<?php
$i=1;
while($row = mysqli_fetch_array($result)){
	...
	<td>'.$row['college_roll_no'].'</td><td>&nbsp;&nbsp;</td><td>'.strtoupper($pgsub1['subject']).'</td><td>'.strtoupper($pgsub2['subject']).'</td><td>'.strtoupper($pgsub3['subject']).'</td>
	<td>'.strtoupper($pgsub4['subject']).'</td><td>'.strtoupper($pgsub5['subject']).'</td><td>'.strtoupper($pgsub6['subject']).'</td><td>'.$row['univ_roll'].'</td><td>'.$row['year'].'</td><td>'.$row['obt_marks'].'</td></tr>';
}
?>
</tbody>
</table>
