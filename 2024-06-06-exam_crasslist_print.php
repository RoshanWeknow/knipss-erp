	...
	<body>
		<div class="row noprint">
			<div class="col-md-12">
				...
				echo '<div class="pagination"><ul><li><a href="exam_crasslist_print.php?back=1">Back</a></li>';
				if ($total_pages > 1) {
							...
							<tr style="border:1px solid black;border-style: ;">
											...
											while ($row2 = mysqli_fetch_assoc($result2)) {
												...
												if (!in_array($paperCode, $paperCodeArray)) {
													...
													?>		
														...
														?>		
															<td> <?php echo (!isset($row3['practical_paper_code']))?($show_obt = ($theory_marks_obt=="Abs")?'Abs':$total_obt_t) /*.'||'.$total_max_sub */:'';?></td>
															<td> <?php echo (!isset($row3['practical_paper_code']))?$earned_credit_t :'';?></td>
															<td> <?php echo (!isset($row3['practical_paper_code']))?$grade_erned_t :'';?></td>
															<td> <?php echo (!isset($row3['practical_paper_code']))?$grade_credit_erned_t:'';?></td>
															<td> <?php
																if($show_obt=='Abs'){
																	echo 'AB';
																}else{	
																	echo (!isset($row3['practical_paper_code']))?calculate_grade_letter($total_obt_t, ((float)$theory_marks_max+(float)$mid_marks_max)):'';
																}?>
															</td>
														<?php
															}
														...
														?>
															...
															<td><?php 
																if($lt_grade1 == 'AB1'){
																	...
																	echo calculate_grade_letter($total_obt_t, ((float)$theory_marks_max+(float)$mid_marks_max));
																}
																?>
															</td>
														<?php }
													...
													<tr style="border:1px solid black; border-style:;">
														...
														if($row4['type']=='Vocational'){
															...
															if($practical_marks_obt_p=='Abs' AND $theory_marks_obt=='Abs'){
																$lt_grade1 = 'AB';
																echo '<td style="position:relative;"><div class="merge_column">Abs</div></td>';
															}else{
																echo '<td style="position:relative;"><div class="merge_column">'.$tot_sub_pract_theo.'</div></td>';
															} 
														?>
															<!--<td style="position:relative;"><div class="merge_column"><?php //echo $tot_sub_pract_theo //echo $total_max_pract_theo; ?>--</div></td>-->
														<?php 
															}else{ 
														?>	
															<td> <?php  echo $practical_marks_obt_p_show = $practical_marks_obt_p; ?></td>
														<?php } ?>	
														<?php
														...
														?>	
															<td style="position:relative;"><div class="merge_column"><?php echo $earned_credit_p_t; ?></td>
															<td style="position:relative;"><div class="merge_column"><?php echo $grade_erned_p_t; ?></td>
															<td style="position:relative;"><div class="merge_column"><?php echo $grade_credit_erned_p_t; ?></td>
															<td style="position:relative;"><div class="merge_column">
															<?php if($lt_grade1 == 'AB'){
																		echo 'AB';
																	}else{
																		echo calculate_grade_letter($tot_sub_pract_theo, $total_max_pract_theo); 
																	}
															?></td>	
														<?php 
															}else {
								...
								<td width="20%" valign="top">
									<table width="100%">
										...
										<tr>
											<?php $total_rows_count = ($count_row-1-($cocurricular_count)); ?>
											<?php
											...
											?>
											<td ><b><?php echo $total_obt.'/'.$total_max; ?></b></td>
											<td ><b><?php echo $avg_credit; ?></b></td>
											<td ><b><?php echo $avg_credit; ?></b></td>
									...
									<!--<table width="100%">
										<tr>
										    <td ><b>TOTAL GRADE POINT</b></td>
											<?php $total_rows_count = ($count_row-1-($cocurricular_count)); ?>
											<td ><b><?php echo $total_grade_credit_erned_point//.'/'.$total_rows_count; ?></b></td>
										</tr>
										<tr>
										    <td ><b>GRADE POINT AVG</b></td>
											<?php
											if($total_rows_count!=0){
												$avg_credit_grade = ($total_grade_credit_erned_point/$tot_course_credit);
											}else{
										...
										<tr>
											...
											<td ><b><?php echo $tot_obt_credit.'/'.$total_max; ?></b></td>
										</tr>
										<tr>
										    <td ><b>RESULT</b></td>
											<td ><b><?php echo $passing_status; ?></b></td>
										</tr>
									</table>-->
								</td>
							</tr>
