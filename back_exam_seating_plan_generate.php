            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="row">
							...
							<div class="col-3"><label for="">Year Part</label><select name="year_part" id="year_part" class="form-control" onChange="fn_year_part_paper(this.value,  '<?php echo $_POST['paper']; ?>')"></select></div>
							<div class="col-3"><label for="">Paper</label><select name="paper" id="paper" class="form-control"></select></div>
							<div class="col-3"><label for="">Type</label>
				...
				if($_POST['paper']!=''){
					...
					<table class="table table-striped table-hover" id="general_stat_table">
						...
						//$sql = 'select * from back_exam_student_paper_info where paper_code="'.$_POST['paper'].'" and class_id="'.$_POST['year_part'].'" and theory_practical!="Practical"';
						
						$sql = 'select "Regular" as student_type, group_name, class_description, exam_roll_no, exam_form_no, student_name, gender, father_name, back_exam_student_paper_info.type as type, type_status,  back_exam_student_paper_info.subject_id as subject_id, paper_code, title_of_paper 
						from back_exam_student_paper_info 
						left join back_exam_student_info on back_exam_student_info.sno = exam_student_info_sno 
