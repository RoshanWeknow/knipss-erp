	...
	if (isset($_POST['submit'])){
		...
		if(isset($_POST['login_button'])){
			if($_POST['exam_form_no']!=''){	
				$sql = 'select * from back_exam_student_info where exam_form_no="'.$_POST['exam_form_no'].'" ';
				//echo $sql;
				...
				<div class=" card  p-4" >
					...
					<div class="col-md-6">
						...
						<label for="selectOption">Religion</label>
								<input disabled type="text" name="religion" id="religion" class="form-control bolding bolding " value="<?php echo $row['religion']; ?>"  tabindex="<?php echo $tabindex++;?>" >
			...
			<div class="row">
				<div class="col-md-12">
					...
					<table class="table  table-bordered table-striped " width="100%">
						...
						<?php
								$i=1;
								$sql = 'select * from  back_exam_student_paper_info where exam_student_info_sno="'.$row_exam['sno'].'"';
