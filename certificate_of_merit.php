...
if(isset($_POST['enrollment_no']) && $_POST['enrollment_no'] != ''){
	...
	if(isset($_POST['edit']) && $_POST['edit']!= ''){
		$sql = 'update ct_merit_certificate set 
		...
		$sql = 'insert into ct_merit_certificate(enrollment_no,name,institution_name,course_starting_date,course_ending_date,issue_date,description,created_by,creation_time) values(
		"'.$_POST['enrollment_no'].'","'.
		$_POST['name'].'","'.
...
if (isset($_GET['edit'])) {
	$sql = 'select * from ct_merit_certificate where sno=' . $_GET['edit'];
	$data = mysqli_fetch_assoc(execute_query($db,$sql));
}

if(isset($_GET['del']) and $_GET['del']!='') {
		$sql = 'delete from ct_merit_certificate where sno=' . $_GET['del'];
		...
		<div class="card card-body">
			<table  class="table table-striped table-hover rounded">
				...
				<?php
					...
					$sql = 'select * from ct_merit_certificate';
