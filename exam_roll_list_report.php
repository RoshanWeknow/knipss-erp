		...
		<div class="row">
            <div class="col-md-12">
				...
				if(isset($_POST['course'])){
					...
					<button class="btn btn-success " id="toExcelBtn">Export to Excel</button>
					...
					<table class="table table-striped table-hover" id="general_stat_table">
						...
						while($row=mysqli_fetch_assoc($result)){
							...
							$sql = 'select * from student_info2 where student_id="'.$row_stu_info['sno'].'" and type="admission"';
...
<script>
	document.getElementById("toExcelBtn").addEventListener('click', function(){
		...
		table2excel.export(document.querySelector("#general_stat_table"),"Roll List");
	});
</script>
