...
<?php	
	if(isset($_POST['submit2'])){
		...
		$sql = 'UPDATE `bba_bba_lib_issue_book` SET `status`=0,
	...
	<div class="card card-body">    
		<div class="row d-flex my-auto">  	
			<div class="d-flex  justify-content-between">
				...
				<div><a href="bba_lib_book_return.php" style="margin-right:2rem;" class="btn btn-danger" >Back</h3></a></div>
			</div>
			<div class="col-md-12" >
					...
					<tr class="bg-primary text-white" align="center">
						...
						<?php
							...
							elseif(isset($_POST['first_date']) && isset($_POST['last_date'])){
								...
								$query = 'select * from bba_lib_issue_book ';
							}
							//echo $query;
