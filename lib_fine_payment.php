...
<?php	
    ...
    if(isset($_POST['edit']) && $_POST['edit'] != ''){
        $sql = 'UPDATE lib_fine_payment set 
			...
			// echo $sql;		 
				...
				$sql = 'INSERT INTO lib_fine_payment(lib_loc, lib_card_no, student_name, from_date, upto_date, created_by, creation_time) 
	...
	if(isset($_GET['del'])){
		$sql = 'delete from lib_fine_payment where sno="'.$_GET['del'].'"';
		mysqli_query($db, $sql);
		if(mysqli_error($db)){
	...
	if(isset($_GET['edit'])){
	$sql = 'select * from lib_fine_payment where sno = '.$_GET['edit'];
	...
	<div class="card">
		<div class="card-body ">
			<div class="row d-flex my-auto">
				...
				<div class="bg-primary text-white p-2"><h3>Fine Payment</h3></div>
					<table width="100%" class="table table-striped table-hover rounded">
						<tr class="">
							...
							<th>Student Name</th>
							<th><input type="text" name="student_name" id="student_name" value="<?php echo isset($_GET['edit'])? $res['student_name']: '' ?>" class="form-control" required="required"></th>
				...
				<div class="col-md-12" >
					<table width="80%" class="table table-striped  table-hover rounded">
						<tr class="bg-primary text-white">
							...
							<?php
								$sql = 'select * from lib_fine_payment';
								...
								while($row = mysqli_fetch_assoc($result)){
									...
									<td>'.$row['from_date'].'</td>
									<td>'.$row['upto_date'].'</td>
									<td><a href="lib_fine_payment.php?edit='.$row['sno'].'" onClick="return confirm(\'Are you sure? \');" <h3 style="color: #3066ec;"> Edit</h3></a></td>
									<td><a href="lib_fine_payment.php?del='.$row['sno'].'" onClick="return confirm(\'Are you sure? \');" <h3 style="color:red;"></h3>Delete</a></td>
										</tr>'	;
								}
							?>
					</table>
