		...
		<div class="card">
			<div class="card-header">
				...
				<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST" enctype="multipart/form-data" id="" name="" target="_blank">
					<?php echo $msg; ?> 
					<div class="col-md-12">
						<h2 class="bg-primary text-white p-2" style="text-align:center;">Datewise Shiftwise Duty Report</h2>
						<div class="row">
						...
						<div class="row pt-3">
							<div class="col-md-12">
								<h3 style="text-align:center;background-color:#0d6efd;color:white;height:4rem;line-height:4rem;">DETAILS OF DATEWISE SHIFTWISE DUTY REPORT</h3>
								<div class="d-flex">
									<div class="pt-2 pb-3">
								...
								<table class="table">
									<tr>
										...
										<th scope="col">ROOM INVIGILATOR</th>
										<th scope="col">ROOM INVIGILATOR AMOUNT</th>
										<th scope="col">RELIEVER</th>
										<th scope="col">RELIEVER AMOUNT</th>
										<th scope="col">ASSISTANT SUPERINTENDENT</th>
										<th scope="col">ASSISTANT SUPERINTENDENT AMOUNT</th>
										<th scope="col">CENTER SUPRINT AMOUNT</th>
