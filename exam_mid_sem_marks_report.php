...
?>
<?php
	$sql_allot_data = 'Select * from mid_sem_marks_allotment where sno = "'.$_GET['id'].'"';
	...
	<body class="w-100 m-auto">
		...
		<div class="container-fluid m-auto cont ">
			<div class="container-fluid border">
				...
				<table width="100%" style="margin:0px;" id="table1">
					<thead>
						<tr>
				...
				<table  width="100%" class="table table-bordered border"  id="table2">
						...
						<tr>
							...
							<td scope="col" width="15%"><?php echo $row_allot_data['max_marks']; ?></td>
						</tr>
						<tr>
				...
				<table  width="100%" class="table table-bordered border  " align="center" id="bodys">
					...
					<tr align="center">
						...
						<?php
							$sql_examiner = 'Select * from mid_sem_marks_allotment where sno = "'.$_GET['id'].'"';
							$row_examiner = mysqli_fetch_assoc(mysqli_query($db, $sql_examiner));
						
							//$query = 'SELECT *,exam_student_paper_info.sno as stu_paper_id FROM `exam_student_paper_info` LEFT JOIN exam_student_info on exam_student_info_sno=exam_student_info.sno  WHERE mid_sem_allotment ="'.$_GET['id'].'" AND paper_code ="'.$_GET['ppr'].'" ORDER BY exam_roll_no';
							$query = "SELECT 
												...
												exam_student_paper_info.mid_sem_marks_obt,
											...
											WHERE 
												mid_sem_allotment ='".$_GET['id']."' AND paper_code ='".$_GET['ppr']."' AND exam_roll_no IS NOT NULL
											...
											SELECT 
												...
												back_exam_student_paper_info.mid_sem_marks_obt,
											...
											WHERE 
												mid_sem_allotment ='".$_GET['id']."' AND paper_code ='".$_GET['ppr']."'
											ORDER BY 
												exam_roll_no ";
							//echo $query;
						...
						<tr>
							...
							<td><?php echo $row['mid_sem_marks_obt'] ;?></td>
							<td><?php echo strtoupper(int_to_words($row['mid_sem_marks_obt'])) ;?></td>
						</tr>
						<?php
							}	
							?>
				...
				<table  width="100%" class="border " id="footers" >
					<tfoot>
						<tr style="height:20px">
							<th scope="col" width="50%" style="padding-left:1rem!important;"><?php echo $row_examiner['examiner'] ;?></th>
							<th scope="col"  width="50%" style="text-align:right;padding-right:5rem!important;" ><?php echo $row_examiner['v_auth'] ;?></th>
						</tr>
						<tr style="height:20px">
						...
						<tr >
							<th scope="col" colspan="2" >NOTE: PLEASE SEND SIGNED COPY OF AWARD SHEET TO INSTITUTE AS SOON AS POSSIBLE. ADDRESS: CONTROLLER OF EXAMINATION KAMLA NEHRU INSTITUTE OF PHYSICAL & SOCIAL SCIENCES,SULTANPUR - 228181</th>
						</tr>
					</tfoot>
