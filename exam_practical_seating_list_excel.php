...
if(isset($_POST['center_name'])){
	...
	$sheet->setCellValue('A2', 'EXAMINATION - 2024');
	...
	$i=8;
	$a=1;
	$sql = 'select student_name, father_name, college_roll_no, exam_form_no, exam_roll_no, uin_no from exam_student_paper_info 
	left join exam_student_info on  exam_student_info.sno = exam_student_paper_info.exam_student_info_sno
