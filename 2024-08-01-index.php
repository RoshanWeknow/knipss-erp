...
function show_db(){
	$connect = mysqli_connect("localhost","knipsserp", "Knipss@13579", "knipsser_2023");
	if(!$connect){
...
?>
	<div class=" card">
		<div class="header">
			...
			<p style="text-align:center;">( SESSION : KNIPSS <?php echo $current_session['value']; ?> )</p>
			<h4 class="title text-center">Quick Links</h4>
