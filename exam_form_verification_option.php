		...
		<div class="row">
			<div class="col-md-3 text-center" style="display: flex; justify-content: center; align-items: center;">
				<div style="display: inline-flex; align-items: center; justify-content: center; border: 3px solid orange; border-radius: 30px; background-color: gray; padding: 10px 20px; margin: 10px; color: white; font-family: Arial, sans-serif; font-size: 1em; width: 200px; height: 100px;">
					<a href="exam_verify_status.php" style="color: white; text-decoration: none;" target="_blank">
			...
			<div class="col-md-3 text-center" style="display: flex; justify-content: center; align-items: center;">
				<div style="display: inline-flex; align-items: center; justify-content: center; border: 3px solid orange; border-radius: 30px; background-color: gray; padding: 10px 20px; margin: 10px; color: white; font-family: Arial, sans-serif; font-size: 1em; width: 200px; height: 100px;">
					<a href="exam_form_pending_report.php" style="color: white; text-decoration: none;" target="_blank">
			...
			<div class="col-md-3 text-center" style="display: flex; justify-content: center; align-items: center;">
				<div style="display: inline-flex; align-items: center; justify-content: center; border: 3px solid orange; border-radius: 30px; background-color: gray; padding: 10px 20px; margin: 10px; color: white; font-family: Arial, sans-serif; font-size: 1em; width: 200px; height: 100px;">
					<a href="back_exam_verify_status.php" style="color: white; text-decoration: none;" target="_blank">
						BACK EXAM FORM VERIFICATION
					</a>
				</div>
			</div>
			<div class="col-md-3 text-center" style="display: flex; justify-content: center; align-items: center;">
				<div style="display: inline-flex; align-items: center; justify-content: center; border: 3px solid orange; border-radius: 30px; background-color: gray; padding: 10px 20px; margin: 10px; color: white; font-family: Arial, sans-serif; font-size: 1em; width: 200px; height: 100px;">
					<a href="back_exam_form_pending_report.php" style="color: white; text-decoration: none;" target="_blank">
