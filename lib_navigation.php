...
header_lib();
	...
	if(isset($_POST['submit'])){
		if($_POST['edit_sno']==''){
			$sql = 'insert into lib_navigation (
				`hyper_link` ,
				`icon_image` ,
				`link_description` ,
				`parent` ,
...
if(isset($_GET['edit_sno'])){
	$sql = 'select * from lib_navigation where sno="'.$_GET['edit_sno'].'"';
...
if(isset($_GET['del'])){
	$sql = 'delete from lib_navigation where sno="'.$_GET['del'].'"';
	mysqli_query($db,$sql);
            ...
            <div class="col-md-12">
                <div class="card">
					...
					<table class="table table-striped table-hover">
						...
						<?php
						$i=1;
						$sql = 'select * from lib_navigation ';
