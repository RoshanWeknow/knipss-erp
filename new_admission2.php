	...
	<div id="container">
						...
						<div class="col-md-12">
							...
							<table width="100%" class="table table-striped-success table-hover rounded ">
								<tr class="table-secondary">
									...
									<th width="16%">Select class </th>
									<th width="17%"><select name="s_class" class="form-control" id="s_class"  value="<?php if(isset($_POST['s_class'])){echo $_POST['s_class'];} ?>" onChange="get_subject(this.value)" onFocus="fnTXTFocus(this.id)" >
									 ...
									 <th width="15%"><input type="text" id="batch" name="batch" class="form-control"  value="<?php if(isset($_POST['batch'])){echo $_POST['batch'];} ?>"></th>
								</tr>
								<?php } ?>
								<tr >									
									<th>Subject 1.</th>
									<th><select name="sub1"   class="form-control"  id="sub1"  value="<?php if(isset($_POST['sub1'])){echo $_POST['sub1'];} ?>" onFocus="fnTXTFocus(this.id)"><option value=""></option></select></th>
									<th>Subject 2.</th>
									<th><select name="sub2"   class="form-control"  id="sub2"  value="<?php if(isset($_POST['sub2'])){echo $_POST['sub2'];} ?>" onFocus="fnTXTFocus(this.id)"><option value=""></option></select></th>
									<th>Subject 3.</th>
									<th><select name="sub3"  class="form-control"  id="sub3"  value="<?php if(isset($_POST['sub3'])){echo $_POST['sub3'];} ?>" onFocus="fnTXTFocus(this.id)"><option value=""></option></select></th>
								</tr>								
								<tr class="table-secondary">
									<th>Minor/Elective: </th>
									<th><select name="other_sub1"  value="" class="form-control"  id="other_sub1" onFocus="fnTXTFocus(this.id)">
										...
										while($row_minor = mysqli_fetch_assoc($result_minor)){
											echo '<option value="'.$row_minor['sno'].'">'.$row_minor['subject'].'</option>';
										}
						
										?>
									 </select></th>
									<th>Co-curricular:</th>
									<th><select name="other_sub1"  value="" class="form-control" id="other_sub1"  name="other_sub2"  value="" class="form-control"  id="other_sub2" onFocus="fnTXTFocus(this.id)">
									...
									<th><select name="other_sub3"  value="" class="form-control"  id="other_sub3" onFocus="fnTXTFocus(this.id)">
								...
								<tr>
									<th>Form Number</th>
									<th><input class="form-control"   type="text" id="tax11" maxlength="10" size="10" name="form_no" value="<?php if(isset($_POST['form_no'])){echo $_POST['form_no'];} ?>" onFocus="fnTXTFocus(this.id)" /></th>
									<th>Student Name </th>
									<th><input class="form-control"  id="s_name" maxlength="45" size="40" value="<?php if(isset($_POST['s_name'])){echo $_POST['s_name'];} ?>"  name="s_name" onFocus="fnTXTFocus(this.id)" ></th>
									<th>Father's Name</th>
									<th><input class="form-control"  id="f_name" maxlength="35" size="40" name="f_name" value="<?php if(isset($_POST['f_name'])){echo $_POST['f_name'];} ?>" onFocus="fnTXTFocus(this.id)" ></th>
								</tr>
								<tr class="table-secondary">
									<th>Mother's Name </th>
									<th><input class="form-control"  id="m_name" maxlength="35" size="40" name="m_name"  value="<?php if(isset($_POST['m_name'])){echo $_POST['m_name'];} ?>" onFocus="fnTXTFocus(this.id)" ></th>
									<th>Date of Birth</th>
									<th><script  type="text/javascript" language="javascript">
										document.writeln(DateInput('dob', 'dob', true, 'YYYY-MM-DD', '2023-02-27', <?php echo $tab; $tab+=4;?>));
									</script></th>
									<th>Gender</th>
								...
								<tr>
									<th>Category</th>
									<th><select class="form-control"  name="opt_cat" id="opt_cat" value="<?php if(isset($_POST['opt_cat'])){echo $_POST['opt_cat'];} ?>" onChange="changefees1(this.value)" onFocus="fnTXTFocus(this.id)" tabindex="<?php echo $tab++; ?>">
									...
									<th>Minority</th>
									<th><select class="form-control"  name="opt_minor" id="opt_minor"   value="<?php if(isset($_POST['opt_minor'])){echo $_POST['opt_minor'];} ?>" onChange="changefees1(this.value)" onFocus="fnTXTFocus(this.id)" tabindex="<?php echo $tab++; ?>">
								...
								<tr class="table-secondary">
									...
									<th><select name="prev_univ"  class="form-control" id="prev_univ"  value="<?php if(isset($_POST['prev_univ'])){echo $_POST['prev_univ'];} ?>" onFocus="fnTXTFocus(this.id)"  tabindex="<?php echo $tab++; ?>" >
										<option value=""></option>
										<option value="awadh">Dr.R.M.L.Awadh University</option>
										<option value="other">Other University</option>
									 </select></th>
									<th>Aadhar Number</th>
									<th><input class="form-control"  id="aadhar_number" maxlength="35" size="40" name="aadhar_number"  value="<?php if(isset($_POST['aadhar_number'])){echo $_POST['aadhar_number'];} ?>" onFocus="fnTXTFocus(this.id)" ></th>
									<th></th>
									<th></th>
								</tr>
							</table>
							...
							<table width="100%" class="table table-striped-success table-hover rounded ">									
								<tr class="table-secondary">
									...
									<th><input type="text"class="form-control"  name="income_cert" size="15"  value="<?php if(isset($_POST['income_cert'])){echo $_POST['income_cert'];} ?>" onFocus="fnTXTFocus(this.id)" tabindex="<?php echo $tab++; ?>"></th>
		...
		<table width="100%" class="table table-striped-success table-hover rounded ">
			...
			<?php $k=1; ?>
            	<td><?php echo $k++; ?></td>
                <td>High School</td>
                <td><input type="text" name="high_school_board" value="<?php if(isset($_POST['Submit3'])){echo $_POST['high_school_board'];}?>" tabindex="<?php echo $tab++;?>"></td>
                <td><input type="text" name="high_school_college" value="<?php if(isset($_POST['Submit3'])){echo $_POST['high_school_college'];}?>" tabindex="<?php echo $tab++;?>"></td>
                <td><input type="text" name="high_school_year" value="<?php if(isset($_POST['Submit3'])){echo $_POST['high_school_year'];}?>" maxlength="12" 
					class="fieldtextmedium" style="width:50px;" tabindex="<?php echo $tab++;?>"></td>
                <td><input type="text" name="high_school_roll_no" maxlength="12" 
					class="fieldtextmedium" style="width:50px;" value="<?php if(isset($_POST['Submit3'])){echo $_POST['high_school_roll_no'];}?>" tabindex="<?php echo $tab++;?>"></td>
                <td><input type="text" name="high_school_obt" maxlength="12" 
					class="fieldtextmedium" style="width:50px;" value="<?php if(isset($_POST['Submit3'])){echo $_POST['high_school_obt'];}?>" tabindex="<?php echo $tab++;?>" id="high_school_obt"></td>
                <td><input type="text" name="high_school_total" maxlength="12" 
					class="fieldtextmedium" style="width:50px;" value="<?php if(isset($_POST['Submit3'])){echo $_POST['high_school_total'];}?>" tabindex="<?php echo $tab++;?>" onBlur="get_perc('high_school')" id="high_school_total"></td>
                <td><input type="text" name="high_school_perc" maxlength="12" 
					class="fieldtextmedium" style="width:50px;" value="<?php if(isset($_POST['Submit3'])){echo $_POST['high_school_perc'];}?>" tabindex="<?php echo $tab++;?>" id="high_school_perc" OnBlur="get_division('high_school')" readonly/></td>
                <td><input type="text" name="high_school_division" maxlength="12" class="fieldtextmedium" style="width:50px;" value="<?php if(isset($_POST['Submit3'])){echo $_POST['high_school_division'];}?>" tabindex="<?php echo $tab++;?>" id="high_school_division" readonly/></td>
                <td><select name="high_school_status" tabindex="<?php echo $tab++;?>">
           ...
           <tr>
            	<td><?php echo $k++; ?></td>
                <td>Intermediate</td>
                <td><input type="text" name="inter_board" value="<?php if(isset($_POST['Submit3'])){echo $_POST['inter_board'];}?>" tabindex="<?php echo $tab++;?>"></td>
                <td><input type="text" name="inter_college" value="<?php if(isset($_POST['Submit3'])){echo $_POST['inter_college'];}?>" tabindex="<?php echo $tab++;?>"></td>
             	<td><input name="inter_year" tabindex="<?php echo $tab++;?>" type="text"  value="<?php if(isset($_POST['Submit3'])){echo $_POST['inter_year'];}?>"   maxlength="12" 
                ...
                <td><input type="text" name="inter_roll_no" maxlength="12" 
					class="fieldtextmedium" style="width:50px;" value="<?php if(isset($_POST['Submit3'])){echo $_POST['inter_roll_no'];}?>" tabindex="<?php echo $tab++;?>"></td>
                <td><input type="text" name="inter_obt" maxlength="12" 
					class="fieldtextmedium" style="width:50px;" value="<?php if(isset($_POST['Submit3'])){echo $_POST['inter_obt'];}?>" tabindex="<?php echo $tab++;?>" id="inter_obt"></td>
                <td><input type="text" name="inter_total" maxlength="12" 
					class="fieldtextmedium" style="width:50px;" value="<?php if(isset($_POST['Submit3'])){echo $_POST['inter_total'];}?>" tabindex="<?php echo $tab++;?>" onBlur="get_perc('inter')" id="inter_total"></td>
                <td><input type="text" name="inter_perc" maxlength="12" 
					class="fieldtextmedium" style="width:50px;" value="<?php if(isset($_POST['Submit3'])){echo $_POST['inter_perc'];}?>" tabindex="<?php echo $tab++;?>" id="inter_perc" OnBlur="get_division('inter')" readonly/></td>
                <td><input type="text" name="inter_division" maxlength="12" 
					class="fieldtextmedium" style="width:50px;" value="<?php if(isset($_POST['Submit3'])){echo $_POST['inter_division'];}?>" tabindex="<?php echo $tab++;?>" id="inter_division" readonly/></td>
                <td><select name="inter_status" tabindex="<?php echo $tab++;?>">
						<option value="Passed" <?php if(isset($_POST['Submit3'])){if($_POST['inter_status']=='Passed'){echo 'selected';}}?>>Passed</option>
						<option value="Failed" <?php if(isset($_POST['Submit3'])){if($_POST['inter_status']=='Failed'){echo 'selected';}}?>>Failed</option>
					</select>
				</td>
           </tr>
           <tr class="table-secondary">
           		<td><?php echo $k++; ?></td>
                <td><input type="text" name="grad_exam_name" tabindex="<?php echo $tab++;?>" value="<?php if(isset($_POST['Submit3'])){echo $_POST['grad_exam_name'];}?>">
				</td>
                <td><input type="text" name="grad_board" value="<?php if(isset($_POST['Submit3'])){echo $_POST['grad_board'];}?>" tabindex="<?php echo $tab++;?>"></td>
                <td><input type="text" name="grad_college" value="<?php if(isset($_POST['Submit3'])){echo $_POST['grad_college'];}?>" tabindex="<?php echo $tab++;?>"></td>
                <td><input name="grad_year" tabindex="<?php echo $tab++;?>" type="text"  value="<?php if(isset($_POST['Submit3'])){echo $_POST['grad_year'];}?>"   maxlength="12" 
					class="fieldtextmedium" style="width:50px;"  id="grad_year" /></td>
               
                    <!-- <input type="hidden" value="<?php echo $get_class_details['category']; ?>" id="class_category" > -->
                <td><input type="text" name="grad_roll_no" maxlength="12" 
					class="fieldtextmedium" style="width:50px;" value="<?php if(isset($_POST['Submit3'])){echo $_POST['grad_roll_no'];}?>" tabindex="<?php echo $tab++;?>"></td>
                <td><input type="text" name="grad_obt" maxlength="12" 
					class="fieldtextmedium" style="width:50px;" value="<?php if(isset($_POST['Submit3'])){echo $_POST['grad_obt'];}?>" tabindex="<?php echo $tab++;?>" id="grad_obt"></td>
                <td><input type="text" name="grad_total" maxlength="12" 
					class="fieldtextmedium" style="width:50px;" value="<?php if(isset($_POST['Submit3'])){echo $_POST['grad_total'];}?>" onBlur="get_perc('grad')"  tabindex="<?php echo $tab++;?>" id="grad_total"></td>
                <td><input type="text" name="grad_perc" maxlength="12" 
					class="fieldtextmedium" style="width:50px;" value="<?php if(isset($_POST['Submit3'])){echo $_POST['grad_perc'];}?>" tabindex="<?php echo $tab++;?>" id="grad_perc" OnBlur="get_division('grad')" readonly/></td>
                <td><input type="text" name="grad_division" maxlength="12" 
					class="fieldtextmedium" style="width:50px;" value="<?php if(isset($_POST['Submit3'])){echo $_POST['grad_division'];}?>" tabindex="<?php echo $tab++;?>" id="grad_division" readonly/></td>
                <td><select name="grad_status" tabindex="<?php echo $tab++;?>">
						<option value="Passed" <?php if(isset($_POST['Submit3'])){if($_POST['grad_status']=='Passed'){echo 'selected';}}?>>Passed</option>
						<option value="Failed" <?php if(isset($_POST['Submit3'])){if($_POST['grad_status']=='Failed'){echo 'selected';}}?>>Failed</option>
					</select>
				</td>
           </tr>
           <tr>
           		<td><?php echo $k++; ?></td>
                <td><input type="text" name="pg_exam_name" tabindex="<?php echo $tab++;?>" value="<?php if(isset($_POST['Submit3'])){echo $_POST['pg_exam_name'];}?>">
				</td>
                <td><input type="text" name="pg_board" value="<?php if(isset($_POST['Submit3'])){echo $_POST['pg_board'];}?>" tabindex="<?php echo $tab++;?>"></td>
                <td><input type="text" name="pg_college" value="<?php if(isset($_POST['Submit3'])){echo $_POST['pg_college'];}?>" tabindex="<?php echo $tab++;?>"></td>
                <td><input name="pg_year" tabindex="<?php echo $tab++;?>" type="text"  value="<?php if(isset($_POST['Submit3'])){echo $_POST['pg_year'];}?>"   maxlength="12" 
					class="fieldtextmedium" style="width:50px;"  id="pg_year" /></td>
               
                    <!-- <input type="hidden" value="<?php echo $get_class_details['category']; ?>" id="class_category" > -->
                <td><input type="text" name="pg_roll_no" maxlength="12" 
					class="fieldtextmedium" style="width:50px;" value="<?php if(isset($_POST['Submit3'])){echo $_POST['pg_roll_no'];}?>" tabindex="<?php echo $tab++;?>"></td>
                <td><input type="text" name="pg_obt" maxlength="12" 
					class="fieldtextmedium" style="width:50px;" value="<?php if(isset($_POST['Submit3'])){echo $_POST['pg_obt'];}?>" tabindex="<?php echo $tab++;?>" id="pg_obt"></td>
                <td><input type="text" name="pg_total" maxlength="12" 
					class="fieldtextmedium" style="width:50px;" value="<?php if(isset($_POST['Submit3'])){echo $_POST['pg_total'];}?>" onBlur="get_perc('pg')"  tabindex="<?php echo $tab++;?>" id="pg_total"></td>
                <td><input type="text" name="pg_perc" maxlength="12" 
					class="fieldtextmedium" style="width:50px;" value="<?php if(isset($_POST['Submit3'])){echo $_POST['pg_perc'];}?>" tabindex="<?php echo $tab++;?>" id="pg_perc" OnBlur="get_division('pg')" readonly/></td>
                <td><input type="text" name="pg_division" maxlength="12" 
					class="fieldtextmedium" style="width:50px;" value="<?php if(isset($_POST['Submit3'])){echo $_POST['pg_division'];}?>" tabindex="<?php echo $tab++;?>" id="pg_division" readonly/></td>
                <td><select name="pg_status" tabindex="<?php echo $tab++;?>">
						<option value="Passed" <?php if(isset($_POST['Submit3'])){if($_POST['pg_status']=='Passed'){echo 'selected';}}?>>Passed</option>
						<option value="Failed" <?php if(isset($_POST['Submit3'])){if($_POST['pg_status']=='Failed'){echo 'selected';}}?>>Failed</option>
					</select>
				</td>
           </tr>
         <tr class="table-secondary">
            	<td><?php echo $k++; ?></td>
                <td>Others</td>
                <td><input type="text" name="others_board" value="<?php if(isset($_POST['Submit3'])){echo $_POST['others_board'];}?>" tabindex="<?php echo $tab++;?>"></td>
                <td><input type="text" name="others_college" value="<?php if(isset($_POST['Submit3'])){echo $_POST['others_college'];}?>" tabindex="<?php echo $tab++;?>"></td>
                <td><input type="text" name="others_year" value="<?php if(isset($_POST['Submit3'])){echo $_POST['others_year'];}?>" maxlength="12" 
					class="fieldtextmedium" style="width:50px;" tabindex="<?php echo $tab++;?>"></td>
                <td><input type="text" name="others_roll_no" maxlength="12" 
					class="fieldtextmedium" style="width:50px;" value="<?php if(isset($_POST['Submit3'])){echo $_POST['others_roll_no'];}?>" tabindex="<?php echo $tab++;?>"></td>
                <td><input type="text" name="others_obt" maxlength="12" 
					class="fieldtextmedium" style="width:50px;" value="<?php if(isset($_POST['Submit3'])){echo $_POST['others_obt'];}?>" tabindex="<?php echo $tab++;?>" id="others_obt"></td>
                <td><input type="text" name="others_total" maxlength="12" 
					class="fieldtextmedium" style="width:50px;" value="<?php if(isset($_POST['Submit3'])){echo $_POST['others_total'];}?>" tabindex="<?php echo $tab++;?>" onBlur="get_perc('others')" id="others_total"></td>
                <td><input type="text" name="others_perc" maxlength="12" 
					class="fieldtextmedium" style="width:50px;" value="<?php if(isset($_POST['Submit3'])){echo $_POST['others_perc'];}?>" tabindex="<?php echo $tab++;?>" id="others_perc" OnBlur="get_division('others')" readonly/></td>
                <td><input type="text" name="others_division" maxlength="12" class="fieldtextmedium" style="width:50px;" value="<?php if(isset($_POST['Submit3'])){echo $_POST['others_division'];}?>" tabindex="<?php echo $tab++;?>" id="others_division" readonly/></td>
                <td><select name="others_status" tabindex="<?php echo $tab++;?>">
						<option value="Passed" <?php if(isset($_POST['Submit3'])){if($_POST['others_status']=='Passed'){echo 'selected';}}?>>Passed</option>
						<option value="Failed" <?php if(isset($_POST['Submit3'])){if($_POST['others_status']=='Failed'){echo 'selected';}}?>>Failed</option>
					</select>
				</td>
           </tr>
		</table>
			...
			<div style="display: none;" name="info_table" id="info_table">
				<table width="100%" class="table table-striped-primary table-hover rounded ">	
					...
					<tr class="table-secondary">
						...
						<td><input type="text" name="p_mobile"class="form-control" id="p_mobile" value="<?php if(isset($_POST['p_mobile'])){echo $_POST['p_mobile'];} ?>"></td>
					...
					<tr class="table-secondary">
						...
						<td>WhatsApp Mobile No</td>
						<td><input type="text" name="c_mobile"class="form-control" id="c_mobile" value="<?php if(isset($_POST['c_mobile'])){echo $_POST['c_mobile'];} ?>"></td>
	...
	<div id="wrapper">	
        ...
        <table class="table table-striped">
        	<tr>
            	...
            	<?php
				if(isset($_POST['fees_discount'])){
					echo '<th>Total Fees : '.($_POST['fees']+$_POST['fees_discount']).'<input type="hidden" name="total_fees" value="'.$_POST['fees'].'"></th>';
			...
			<tr>
                <th>Total Fees :
                <?php $main_total=$comp_fees+ $self_fees+ $total+ $tour_fees+$vocational;
				 echo $main_total;?></th>
		...
		<tr>
			...
			<th><?php echo $_POST['prev_univ']; ?>
				<input type="hidden" name="prev_univ" value="<?php echo $_POST['prev_univ']; ?>"></th>
		</tr>
		<tr>
		...
		<tr>
			...
			<th><?php echo $_POST['p_mobile']; ?>
				<input type="hidden" name="p_mobile" value="<?php echo $_POST['p_mobile']; ?>"></th>
		</tr>
	</table>
