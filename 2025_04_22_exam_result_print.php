        ...
        <div class="container-fluid" style="margin-top:5.2cm; ">
           ...
           <h3 class="text-center mb-4">STATEMENT OF MARKS<br><span style="font-size:16px;">2023-2024<br><br><span><h3>
							...
							<?php
								...
								<tr style="border:1px solid black; border-style:;">
									...
									?>
										...
										<td style="position:relative;"><div class="merge_column"><?php echo $credit_paper_p_t = $credit_paper_p+$credit_paper_t; ?></div></td>
										...
										if($practical_marks_obt_p_show == 'Abs'){
										 ...
										 ?></div></td>
										<td style="position:relative; border:none;"><div class="merge_column"><?php echo $grade_erned_p_t = calculate_grade($practical_marks_obt_p_t, $practical_marks_max_p_t);?></div></td>
										<td style="position:relative;"><div class="merge_column"><?php echo $grade_credit_erned_p_t = ((float)$earned_credit_p_t*(float)$grade_erned_p_t); ?></div></td>
										<td style="position:relative;"><div class="merge_column"><?php echo (($practical_marks_obt_p_show=='Abs')?'AB':calculate_grade_letter($practical_marks_obt_p_t, $practical_marks_max_p_t)).'</td>';?></div></td>
			...
			<table width="100%" class="table  " style="border:1px solid black; ">
				...
				<tr>
					<td colspan="3">NC = NON CREDITED , NA = NOT APPLICABLE , ATKT = ALLOWED TO KEEP TERM , # = PASSED WITH GRACE</td>
				</tr>
			</table>
...
<table width="100%">
    <tr>
        <th width="50%">
            <img src="image/barcode.gif" style="height:60px;">
        </th>
        <th rowspan="2" width="50%">
            <img src="image/KNI20233658.png" style="height:90px;">
        </th>
    </tr>
    <tr>
        <th> RESULT DECLARATION DATE : 30/01/2024 </th>
        <th style="font-size:16px!important;"> Signature </th>
    </tr>
</table>
