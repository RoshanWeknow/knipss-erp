...
<tr>
<th>S.No</th><th>FATHER/ HUSBAND NAME</th><th>STUDENT NAME</th><th>COLLEGE ROLL NO</th><th>UNIVERSITY ROLL NO</th><th>ENROLLMENT NO</th><th>SUBJECT 1</th><th>SUBJECT 2</th><th>SUBJECT 3</th>
</tr>
</thead>
<tbody>
<?php
...
$sub3 = mysqli_fetch_array(execute_query(connect(), 'select * from add_subject where sno='.$row['sub3']));
		...
		<td>'.$row['college_roll_no'].'</td><td>&nbsp;&nbsp;</td><td>&nbsp;&nbsp;</td><td>'.$sub1['subject'].'</td><td>'.$sub2['subject'].'</td><td>'.$sub3['subject'].'</td></tr>';
}
?>
</tbody>
</table>
