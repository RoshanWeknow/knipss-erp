	...
	if($msg==''){
		...
		for($i=1; $i<=$_POST['add_rows_id_pp']; $i++){
			...
			if($_POST['pp_title_of_paper_'.$i]!=''){
				$_POST['pp_date_of_publication_'.$i] = $_POST['pp_date_of_publication_'.$i.'_month'].'-'.$_POST['pp_date_of_publication_'.$i.'_year'];
		...
		for($i=1; $i<=$_POST['add_rows_id_bp']; $i++){
			...
			if($_POST['bp_name_of_book_'.$i]!=''){
				$_POST['bp_date_'.$i] = $_POST['bp_date_'.$i.'_month'].'-'.$_POST['bp_date_'.$i.'_year'];
		...
		for($i=1; $i<=$_POST['add_rows_id_aw']; $i++){
			...
			if($_POST['aw_award_title_'.$i]!=''){
				$_POST['aw_award_date_'.$i] = $_POST['aw_award_date_'.$i.'_month'].'-'.$_POST['aw_award_date_'.$i.'_year'];
		...
		for($i=1; $i<=$_POST['add_rows_id_ci']; $i++){
			...
			if($_POST['ci_title_'.$i]!=''){
				$_POST['ci_date_'.$i] = $_POST['ci_date_'.$i.'_month'].'-'.$_POST['ci_date_'.$i.'_year'];
		...
		for($i=1; $i<=$_POST['add_rows_id_ti']; $i++){
			...
			if($_POST['ti_platform_'.$i]!=''){
				$_POST['ti_date_'.$i] = $_POST['ti_date_'.$i.'_month'].'-'.$_POST['ti_date_'.$i.'_year'];
		...
		for($i=1; $i<=$_POST['add_rows_id_rg']; $i++){
			...
			if($_POST['rg_topic_'.$i]!=''){
				$_POST['rg_date_'.$i] = $_POST['rg_date_'.$i.'_month'].'-'.$_POST['rg_date_'.$i.'_year'];
		...
		for($i=1; $i<=$_POST['add_rows_id_pr']; $i++){
			...
			if($_POST['pr_title_'.$i]!=''){
				$sql = 'INSERT INTO `dp_transaction_project_research` (`research_type`, `research_title`, `duration`, `amount`, `funding_agency`, `status`, `personal_info_id`, `pr_attachment`) VALUES ("'.$_POST['pr_type_'.$i].'", "'.$_POST['pr_title_'.$i].'", "'.$_POST['pr_duration_'.$i].'", "'.$_POST['pr_amount_'.$i].'", "'.$_POST['pr_funding_agency_'.$i].'", "'.$_POST['pr_status_'.$i].'", "'.$id.'", "'.$qual_file.'");';
				mysqli_query($db, $sql);
				if(mysqli_error($db)){ 
...
elseif(isset($_POST['un_freeze_data'])){
	...
	$_POST['qual_description_1'] = '';
	$_POST['qual_description_sub_1'] = '';
	$_POST['qual_file_1'] = '';
	...
	$_POST['pp_issue_1'] = '';
	$_POST['pp_page_no_1'] = '';
	$_POST['pp_date_of_publication_1_month'] = date("m");
	$_POST['pp_date_of_publication_1_year'] = date("Y");
	...
	$_POST['bp_isbn_1'] = '';
	$_POST['bp_author_1'] = '';
	$_POST['bp_date_1_month'] = date("m");
	$_POST['bp_date_1_year'] = date("Y");
	$_POST['bp_attachment_1'] = '';
	
	$_POST['aw_award_title_1'] = '';
	$_POST['aw_awardee_bodie_1'] = '';
	$_POST['aw_category_1'] = '';
	$_POST['aw_award_date_1_month'] = date("m");
	$_POST['aw_award_date_1_year'] = date("Y");
	$_POST['aw_award_place_1'] = '';
	$_POST['aw_attachment_1'] = '';
	
	$_POST['ci_title_1'] = '';
	$_POST['ci_type_1'] = '';
	$_POST['ci_date_1_month'] = date("m");
	$_POST['ci_date_1_year'] = date("Y");
	$_POST['ci_attachment_1'] = '';
	
	$_POST['ti_platform_1'] = '';
	$_POST['ti_category_1'] = '';
	$_POST['ti_date_1_month'] = date("m");
	$_POST['ti_date_1_year'] = date("Y");
	$_POST['ti_theme_1'] = '';
	...
	$_POST['rg_topic_1'] = '';
	$_POST['rg_status_1'] = '';
	$_POST['rg_date_1_month'] = date("m");
	$_POST['rg_date_1_year'] = date("Y");
...
if(isset($_GET['edit']) || $_SESSION['profile_id']!=''){
	...
	/*Start Data for Personal Information*/
	...
	$_POST['employee_type_2'] = $row['employee_type_id2']; 
	...
	$home_array = array("faculty" => $_POST['faculty'], 
	"subject" => $_POST['subject'], 
	"area_specialization" => $_POST['area_specialization'], 
	...
	"pan_number" => $_POST['pan_number']);
	$home_msg = '';
	foreach($home_array as $k=>$v){
		if($v=='' || $v=='----Select-----'){
			$home_msg .= '<div class="text text-danger">Data Not Filled : '.$k.'</div>';
		}
	}
	if($home_msg==''){
		$home_pill = 'background:#21C200';
	}
	/*End Data for Personal Information*/
	
	/*Start Data for Address*/
	...
	$address_array = array("c_address1" => $_POST['c_address1'], 
	"c_address2" => $_POST['c_address2'], 
	"c_landmark" => $_POST['c_landmark'], 
	"c_block" => $_POST['c_block'], 
	"c_tehseel" => $_POST['c_tehseel'], 
	...
	foreach($address_array as $k=>$v){
		if($v=='' || $v=='----Select-----'){
			$address_msg .= '<div class="text text-danger">Data Not Filled : '.$k.'</div>';
		}
	}
	if($address_msg==''){
		$address_pill = 'background:#21C200';
	}
	/*End Data for Address*/
	
	
	/*Start Data for Bank and Nominee*/
	...
	$bank_array = array("ac_number" => $row['ac_number'], 
	"ifsc_code" => $row['ifsc_code'], 
	"nominee_name" => $row['nominee_name'], 
	"nominee_dob" => $row['nominee_dob'], 
	"nominee_relation" => $row['nominee_relation'], 
	"nominee_mobile_no" => $row['nominee_mobile_no'], 
	"nominee_aadhar" => $row['nominee_aadhar']);
	$bank_msg = '';
	foreach($bank_array as $k=>$v){
		if($v=='' || $v=='----Select-----'){
			$bank_msg .= '<div class="text text-danger">Data Not Filled : '.$k.'</div>';
		}
	}
	if($bank_msg==''){
		$bank_pill = 'background:#21C200';
	}
	/*End Data for Bank and Nominee*/
	
	
	$_POST['status'] = $row['status'];
	
	
	/*Start Data for Qualifcation*/
	...
	if(mysqli_num_rows($result_qulification)!=0){
		...
		while($row_qual = mysqli_fetch_assoc($result_qulification)){
			...
			$qualification_array['qual_class_id_'.$i] = $row_qual['class_id'];
			$qualification_array['qual_college_name_'.$i] = $row_qual['college_name'];
			$qualification_array['qual_board_name_'.$i] = $row_qual['board_name'];
			$qualification_array['qual_roll_number_'.$i] = $row_qual['roll_number'];
			$qualification_array['qual_year_'.$i] = $row_qual['year_of_passing'];
			$i++;
		}
	}
	else{
		...
		$i=1;
		$qualification_array['qual_class_id_'.$i] = '';
		$qualification_array['qual_college_name_'.$i] = '';
		$qualification_array['qual_board_name_'.$i] = '';
		$qualification_array['qual_roll_number_'.$i] = '';
		$qualification_array['qual_year_'.$i] = '';
	}
	...
	$qualification_msg = '';
	foreach($qualification_array as $k=>$v){
		if($v=='' || $v=='----Select-----'){
			$qualification_msg .= '<div class="text text-danger">Data Not Filled : '.$k.'</div>';
		}
	}
	if($qualification_msg==''){
		$qualification_pill = 'background:#21C200';
	}
	/*End Data for Qualifcation*/
	
	
	/*Start Data for Experience*/
	...
	if(mysqli_num_rows($result_exp)!=0){
		...
		while($row_exp = mysqli_fetch_assoc($result_exp)){
			...
			$experience_array['exp_title_'.$i] = $row_exp['organization_name'];
			$experience_array['exp_designation_'.$i] = $row_exp['designation'];
			$experience_array['exp_job_roles_'.$i] = $row_exp['job_roles'];
			$i++;
		}
	}
	else{
		...
		$_POST['exp_attachment_1'] = '';
		$i=1;
		$experience_array['exp_title_'.$i] = '';
		$experience_array['exp_designation_'.$i] = '';
		$experience_array['exp_job_roles_'.$i] = '';
	}
	
	
	$experience_msg = '';
	foreach($experience_array as $k=>$v){
		if($v=='' || $v=='----Select-----'){
			$experience_msg .= '<div class="text text-danger">Data Not Filled : '.$k.'</div>';
		}
	}
	if($experience_msg==''){
		$experience_pill = 'background:#21C200';
	}
	/*End Data for Experience*/
	
	
	/*End Data for Research Publication*/
	...
	if(mysqli_num_rows($result_pp)!=0){
		...
		while($row_pp = mysqli_fetch_assoc($result_pp)){
			...
			$temp = explode("-", $row_pp['date_of_publication']);
			$_POST['pp_date_of_publication_'.$i.'_month'] = $temp[0];
			$_POST['pp_date_of_publication_'.$i.'_year'] = $temp[1];
	...
	if(mysqli_num_rows($result_bp)!=0){
		...
		while($row_bp = mysqli_fetch_assoc($result_bp)){
			...
			$temp = explode("-", $row_bp['date_of_publication']);
			$_POST['bp_date_'.$i.'_month'] = $temp[0];
			$_POST['bp_date_'.$i.'_year'] = $temp[1];
	...
	if(mysqli_num_rows($result_aw)!=0){
		...
		while($row_aw = mysqli_fetch_assoc($result_aw)){
			...
			$temp = explode("-", $row_aw['award_date']);
			$_POST['aw_award_date_'.$i.'_month'] = $temp[0];
			$_POST['aw_award_date_'.$i.'_year'] = $temp[1];
	...
	if(mysqli_num_rows($result_ci)!=0){
		...
		while($row_ci = mysqli_fetch_assoc($result_ci)){
			...
			$temp = explode("-", $row_ci['ci_date']);
			$_POST['ci_date_'.$i.'_month'] = $temp[0];
			$_POST['ci_date_'.$i.'_year'] = $temp[1];
	...
	if(mysqli_num_rows($result_ti)!=0){
		...
		while($row_ti = mysqli_fetch_assoc($result_ti)){
			...
			$temp = explode("-", $row_ti['ti_date']);
			$_POST['ti_date_'.$i.'_month'] = $temp[0];
			$_POST['ti_date_'.$i.'_year'] = $temp[1];
	...
	if(mysqli_num_rows($result_rg)!=0){
		...
		while($row_rg = mysqli_fetch_assoc($result_rg)){
			...
			$temp = explode("-", $row_rg['registration_date']);
			$_POST['rg_date_'.$i.'_month'] = $temp[0];
			$_POST['rg_date_'.$i.'_year'] = $temp[1];
	...
	if(mysqli_num_rows($result_pr)!=0){
		...
		while($row_pr = mysqli_fetch_assoc($result_pr)){
			...
			$_POST['pr_funding_agency_'.$i] = $row_pr['funding_agency'];
				...
				<form id="sale_form" name="sale_form" class="" autocomplete="off" enctype="multipart/form-data" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" onSubmit="">
					...
					<div class="row">
						<div class="col-12">
							<ul class="nav nav-pills nav-justified">
								<li id="home_pill" class="active" style="<?php echo $home_pill; ?>"><a data-toggle="pill" href="#home">Personal Information</a></li>
								<li id="address_pill" style="<?php echo $address_pill; ?>"><a data-toggle="pill" href="#address">Address</a></li>
								<li id="bank_pill" style="<?php echo $bank_pill; ?>"><a data-toggle="pill" href="#bank">Bank and Nominee</a></li>
								<li id="qualification_pill" style="<?php echo $qualification_pill; ?>"><a data-toggle="pill" href="#qualification">Qualifications</a></li>
								<li id="experience_pill" style="<?php echo $experience_pill; ?>"><a data-toggle="pill" href="#experience">Experience</a></li>
								<li id="research_pill" style="<?php echo $research_pill; ?>"><a data-toggle="pill" href="#research">Research Publication</a></li>
								<li id="conference_pill" style="<?php echo $conference_pill; ?>"><a data-toggle="pill" href="#conference">Conference &amp; Seminar</a></li>
								<li id="awards_pill" style="<?php echo $awards_pill; ?>"><a data-toggle="pill" href="#awards">Awards</a></li>
							</ul>
						</div>
					</div>	
					<div class="tab-content">
						<div id="home" class="tab-pane fade in active">							
							...
							<div class="col-md-12">
								<div class="row">							
									...
									<div class="col-md-3">							
										<label>Subject</label>
										<select name="subject" id="subject" tabindex="<?php echo $tab++; ?>" class="form-control">
											<?php
											$query = "select * from add_subject";
											$run = mysqli_query($db,$query);
											while($data = mysqli_fetch_array($run)){
												echo '<option value="'.$data['sno'].'" ';
												if($data['sno'] == $_POST['subject']){
													echo ' selected="Selected"';
												}
									...
									<div class="col-md-3">							
										<label>Area Off Specialization</label>
									...
									<div class="col-md-3">							
										<label>Research Intrest</label>
										<input type="text" name="research_intrest" id="research_intrest" tabindex="<?php echo $tab++; ?>" class="form-control" value="<?php echo $_POST['research_intrest'];?>">
									</div>
								...
								<div class="row">
									<div class="col-md-3">							
										...
										<input type="hidden" name="employee_type_2" value="1">
										<select class="form-control" name="employee_type" id="employee_type" tabindex="<?php echo $tab++; ?>" onChange="get_designation(this.value);">
											<option value="">--- Select ---</option>
											<?php
											$query = "select * from dp_employee_type";
											$run = mysqli_query($db,$query);
											while($data = mysqli_fetch_array($run)){
												echo '<option value="'.$data['sno'].'" ';
												if($data['sno']==$_POST['employee_type']){
													echo ' selected="Selected"';
												}
									...
									<div class="col-md-3">							
										...
										<select class="form-control" name="employee_group" id="employee_group" tabindex="<?php echo $tab++; ?>">
											<option value="">--- Select ---</option>
											<?php
											$query = "select * from dp_employee_group";
											$run = mysqli_query($db,$query);
											while($data = mysqli_fetch_array($run)){
												echo '<option value="'.$data['sno'].'" ';
												if($data['sno']==$_POST['employee_group']){
													echo ' selected="Selected"';
												}
												echo '>'.trim($data['group_name']).'</option>';
											}
											?>
										</select>
									</div>
						...
						<div id="address" class="tab-pane fade">	
							...
							<div class="row">							
								...
								<div class="col-md-3">							
									...
									<select name="department_name" class="form-control" tabindex="<?php echo $tab++; ?>">
										<option selected=""> ----Select-----</option>										
										<?php
											$query = "select * from dp_department";
											$run = mysqli_query($db,$query);
											while($data = mysqli_fetch_array($run)){
												echo '<option value="'.$data['sno'].'" ';
												if($data['sno']==$_POST['department_name']){
													echo ' selected="Selected"';
												}
												echo '>'.trim($data['department_name']).'</option>';
											}
											?>
									</select>
								</div>
						...
						<div id="qualification" class="tab-pane fade">	
							...
							<div id="add_rows_length_aca" class="row">
								...
								<div class="col-md-2">									
									<label >Attach</label>
									<input type="file" name="oa_attachment_<?php echo $i; ?>" id="oa_attachment_<?php echo $i; ?>" class="form-control" tabindex="<?php echo $tab++; ?>"><?php
							...
							<div id="add_rows_length_aca" class="row">
								<div class="col-md-2"><?php echo $i; ?>.
									<label >Degree</label>
									<select name="rd_title_<?php echo $i; ?>" id="rd_title_<?php echo $i; ?>" class="form-control" tabindex="<?php echo $tab++; ?>">
									<?php
									$sql = 'select * from dp_degree';
									$result_degree = execute_query($db, $sql);
									while($row_degree = mysqli_fetch_assoc($result_degree)){
										echo '<option value="'.$row_degree['sno'].'" ';
										if($row_degree['sno']==$_POST['rd_title_'.$i]){
											echo ' selected="selected" ';
										}
										echo '>'.$row_degree['degree_name'].'</option>';
									}
									?>
									</select>								
								</div>
								<div class="col-md-2">								
									...
									<input type="text" name="rd_university_<?php echo $i; ?>" id="rd_university_<?php echo $i; ?>" class="form-control" placeholder=" " value="<?php echo $_POST['rd_university_'.$i]; ?>" tabindex="<?php echo $tab++; ?>">									
								</div>
								<div class="col-md-2">								
									<label >Subject</label>
									<input type="text" name="rd_subject_<?php echo $i; ?>" id="rd_subject_<?php echo $i; ?>" class="form-control" placeholder=" " value="<?php echo $_POST['rd_subject_'.$i]; ?>" tabindex="<?php echo $tab++; ?>">									
								</div>
								<div class="col-md-2">								
									<label >Title of Research</label>
									<input type="text" name="rd_title_of_research_<?php echo $i; ?>" id="rd_title_of_research_<?php echo $i; ?>" class="form-control" placeholder=" " value="<?php echo $_POST['rd_title_of_research_'.$i]; ?>" tabindex="<?php echo $tab++; ?>">									
								</div>
								<div class="col-md-2">									
									<label >Date of Award</label>
									<script  type="text/javascript" language="javascript">
										document.writeln(DateInput('rd_date_<?php echo $i; ?>', 'sale_form', true, 'YYYY-MM-DD', '<?php echo $_POST['rd_date_'.$i]; ?>', <?php echo $tab; $tab+=4;?>));
									</script>								
								</div>
								<div class="col-md-1">									
									<label >Attach</label>
									<input type="file" name="rd_attachment_<?php echo $i; ?>" id="rd_attachment_<?php echo $i; ?>" class="form-control" tabindex="<?php echo $tab++; ?>">
									<?php
									
										if ($_POST['rd_attachment_'.$i]!='') {
											echo fileExists_img_link($_POST['rd_attachment_'.$i], 'rd_attachment_'.$i);
										}
									?>			
								</div>
								<div class="col-md-1 d-flex justify-content- align-items-center">
									<button type="button" id="add_button_rd" class="btn btn-info pull-right" onClick="add_rows_rd()">Add</button>
								</div>
							</div>
							<?php } ?>
							<input type="hidden" name="add_rows_id_rd" id="add_rows_id_rd" value="<?php echo $_POST['add_rows_id_rd']; ?>">
							<div id="test_rd"></div>
							</div>
							
							<h3>Particulars of NET/JRF/SLET/GATE</h3>
							<div class="row border rounded m-2 p-2 border-secondary">
							<?php
							for($i=1; $i<=$_POST['add_rows_id_jrf']; $i++){
							?>
							<div id="add_rows_length_aca" class="row">
								<div class="col-md-2"><?php echo $i; ?>.
									...
									<select name="jrf_title_<?php echo $i; ?>" id="jrf_title_<?php echo $i; ?>" class="form-control" tabindex="<?php echo $tab++; ?>">
										<option value="NET" <?php echo ($_POST['jrf_title_'.$i]=='NET')?' selected="selected" ':''; ?>>NET</option>
										<option value="JRF" <?php echo ($_POST['jrf_title_'.$i]=='JRF')?' selected="selected" ':''; ?>>JRF</option>
										<option value="SLET" <?php echo ($_POST['jrf_title_'.$i]=='SLET')?' selected="selected" ':''; ?>>SELT</option>
										<option value="GATE" <?php echo ($_POST['jrf_title_'.$i]=='GATE')?' selected="selected" ':''; ?>>GATE</option>
									</select>						
								</div>
								<div class="col-md-2">								
									<label >Name of The Conducting Body</label>
									<input type="text" name="jrf_body_<?php echo $i; ?>" id="jrf_body_<?php echo $i; ?>" class="form-control" placeholder=" " value="<?php echo $_POST['jrf_body_'.$i]; ?>" tabindex="<?php echo $tab++; ?>">									
								</div>
								<div class="col-md-2">									
									<label >Date</label>
									<script  type="text/javascript" language="javascript">
										document.writeln(DateInput('jrf_date_<?php echo $i; ?>', 'sale_form', true, 'YYYY-MM-DD', '<?php echo $_POST['jrf_date_'.$i]; ?>', <?php echo $tab; $tab+=4;?>));
									</script>								
								</div>
								<div class="col-md-1">								
									<label >Roll No</label>
									<input type="text" name="jrf_roll_no_<?php echo $i; ?>" id="jrf_roll_no_<?php echo $i; ?>" class="form-control" placeholder=" " value="<?php echo $_POST['jrf_roll_no_'.$i]; ?>" tabindex="<?php echo $tab++; ?>">									
								</div>
								<div class="col-md-1">								
									<label >Subject</label>
									<input type="text" name="jrf_subject_<?php echo $i; ?>" id="jrf_subject_<?php echo $i; ?>" class="form-control" placeholder=" " value="<?php echo $_POST['jrf_subject_'.$i]; ?>" tabindex="<?php echo $tab++; ?>">									
								</div>
								<div class="col-md-1">								
									<label >Score</label>
									<input type="text" name="jrf_score_<?php echo $i; ?>" id="jrf_score_<?php echo $i; ?>" class="form-control" placeholder=" " value="<?php echo $_POST['jrf_score_'.$i]; ?>" tabindex="<?php echo $tab++; ?>">									
								</div>
								<div class="col-md-1">								
									<label >Where Applicable</label>
									<input type="text" name="jrf_applicable_<?php echo $i; ?>" id="jrf_applicable_<?php echo $i; ?>" class="form-control" placeholder=" " value="<?php echo $_POST['jrf_applicable_'.$i]; ?>" tabindex="<?php echo $tab++; ?>">									
								</div>
								
								<div class="col-md-1">									
									<label >Attach</label>
									<input type="file" name="jrf_attachment_<?php echo $i; ?>" id="jrf_attachment_<?php echo $i; ?>" class="form-control" tabindex="<?php echo $tab++; ?>">
									<?php
									
										if ($_POST['jrf_attachment_'.$i]!='') {
											echo fileExists_img_link($_POST['jrf_attachment_'.$i], 'jrf_attachment_'.$i);
										}
									?>			
								</div>
								<div class="col-md-1 d-flex justify-content- align-items-center">
									<button type="button" id="add_button_jrf" class="btn btn-info pull-right" onClick="add_rows_jrf()">Add</button>
								</div>
							</div>
							<?php } ?>
							<input type="hidden" name="add_rows_id_jrf" id="add_rows_id_jrf" value="<?php echo $_POST['add_rows_id_jrf']; ?>">
							<div id="test_jrf"></div>
							</div>
						</div>
						<div id="experience" class="tab-pane fade">	
							...
							<div id="add_rows_length_exp" class="row">
								...
								<div class="col-md-2">									
									...
									<input type="date" name="exp_period_from_<?php echo $i; ?>" id="exp_period_from_<?php echo $i; ?>" class="form-control" placeholder=" " value="<?php echo $_POST['exp_period_from_'.$i]; ?>" tabindex="<?php echo $tab++; ?>">									
								</div>
								<div class="col-md-2">									
						...
						<div id="research" class="tab-pane fade">
							...
							<div id="add_rows_length_pp" class="row">
								...
								<div class="col-md-2">									
									...
									<div class="row">
										<div class="col-4">
											<select name="pp_date_of_publication_<?php echo $i; ?>_month" id="pp_date_of_publication_<?php echo $i; ?>_month" class="form-control" tabindex="<?php echo $tab++; ?>">
											<option value="01" <?php echo $_POST['pp_date_of_publication_'.$i.'_month']=='01'?' selected="selected"':''; ?>>Jan</option>
											<option value="02" <?php echo $_POST['pp_date_of_publication_'.$i.'_month']=='02'?' selected="selected"':''; ?>>Feb</option>
											<option value="03" <?php echo $_POST['pp_date_of_publication_'.$i.'_month']=='03'?' selected="selected"':''; ?>>Mar</option>
											<option value="04" <?php echo $_POST['pp_date_of_publication_'.$i.'_month']=='04'?' selected="selected"':''; ?>>Apr</option>
											<option value="05" <?php echo $_POST['pp_date_of_publication_'.$i.'_month']=='05'?' selected="selected"':''; ?>>May</option>
											<option value="06" <?php echo $_POST['pp_date_of_publication_'.$i.'_month']=='06'?' selected="selected"':''; ?>>Jun</option>
											<option value="07" <?php echo $_POST['pp_date_of_publication_'.$i.'_month']=='07'?' selected="selected"':''; ?>>Jul</option>
											<option value="08" <?php echo $_POST['pp_date_of_publication_'.$i.'_month']=='08'?' selected="selected"':''; ?>>Aug</option>
											<option value="09" <?php echo $_POST['pp_date_of_publication_'.$i.'_month']=='09'?' selected="selected"':''; ?>>Sep</option>
											<option value="10" <?php echo $_POST['pp_date_of_publication_'.$i.'_month']=='10'?' selected="selected"':''; ?>>Oct</option>
											<option value="11" <?php echo $_POST['pp_date_of_publication_'.$i.'_month']=='11'?' selected="selected"':''; ?>>Nov</option>
											<option value="12" <?php echo $_POST['pp_date_of_publication_'.$i.'_month']=='12'?' selected="selected"':''; ?>>Dec</option>
											</select>
										</div>
										<div class="col-4">
											<input type="text" name="pp_date_of_publication_<?php echo $i; ?>_year" id="pp_date_of_publication_<?php echo $i; ?>_year" class="form-control" value="<?php echo $_POST['pp_date_of_publication_'.$i.'_year']; ?>" tabindex="<?php echo $tab++; ?>">									
										</div>
									</div>
							...
							<div id="add_rows_length_bp" class="row">
								...
								<div class="col-md-2">									
									...
									<div class="row">
										<div class="col-4">
											<select name="bp_date_<?php echo $i; ?>_month" id="bp_date_<?php echo $i; ?>_month" class="form-control" tabindex="<?php echo $tab++; ?>">
											<option value="01" <?php echo $_POST['bp_date_'.$i.'_month']=='01'?' selected="selected"':''; ?>>Jan</option>
											<option value="02" <?php echo $_POST['bp_date_'.$i.'_month']=='02'?' selected="selected"':''; ?>>Feb</option>
											<option value="03" <?php echo $_POST['bp_date_'.$i.'_month']=='03'?' selected="selected"':''; ?>>Mar</option>
											<option value="04" <?php echo $_POST['bp_date_'.$i.'_month']=='04'?' selected="selected"':''; ?>>Apr</option>
											<option value="05" <?php echo $_POST['bp_date_'.$i.'_month']=='05'?' selected="selected"':''; ?>>May</option>
											<option value="06" <?php echo $_POST['bp_date_'.$i.'_month']=='06'?' selected="selected"':''; ?>>Jun</option>
											<option value="07" <?php echo $_POST['bp_date_'.$i.'_month']=='07'?' selected="selected"':''; ?>>Jul</option>
											<option value="08" <?php echo $_POST['bp_date_'.$i.'_month']=='08'?' selected="selected"':''; ?>>Aug</option>
											<option value="09" <?php echo $_POST['bp_date_'.$i.'_month']=='09'?' selected="selected"':''; ?>>Sep</option>
											<option value="10" <?php echo $_POST['bp_date_'.$i.'_month']=='10'?' selected="selected"':''; ?>>Oct</option>
											<option value="11" <?php echo $_POST['bp_date_'.$i.'_month']=='11'?' selected="selected"':''; ?>>Nov</option>
											<option value="12" <?php echo $_POST['bp_date_'.$i.'_month']=='12'?' selected="selected"':''; ?>>Dec</option>
											</select>
										</div>
										<div class="col-4">
											<input type="text" name="bp_date_<?php echo $i; ?>_year" id="bp_date_<?php echo $i; ?>_year" class="form-control" value="<?php echo $_POST['bp_date_'.$i.'_year']; ?>" tabindex="<?php echo $tab++; ?>">									
										</div>
									</div>								
								</div>
								<div class="col-md-2">									
							...
							<div id="add_rows_length_pr" class="row">
								...
								<div class="col-md-2">									
									...
									<input type="text" name="pr_funding_agency_<?php echo $i; ?>" id="pr_funding_agency_<?php echo $i; ?>" class="form-control" placeholder=" " value="<?php echo $_POST['pr_funding_agency_'.$i]; ?>" tabindex="<?php echo $tab++; ?>">									
								</div>
								<div class="col-md-2">									
									<label >Status</label>
						...
						<div id="awards" class="tab-pane fade">
							...
							<div id="add_rows_length_aw" class="row">
								...
								<div class="col-md-2">									
									...
									<div class="row">
										<div class="col-4">
											<select name="aw_award_date_<?php echo $i; ?>_month" id="aw_award_date_<?php echo $i; ?>_month" class="form-control" tabindex="<?php echo $tab++; ?>">
											<option value="01" <?php echo $_POST['aw_award_date_'.$i.'_month']=='01'?' selected="selected"':''; ?>>Jan</option>
											<option value="02" <?php echo $_POST['aw_award_date_'.$i.'_month']=='02'?' selected="selected"':''; ?>>Feb</option>
											<option value="03" <?php echo $_POST['aw_award_date_'.$i.'_month']=='03'?' selected="selected"':''; ?>>Mar</option>
											<option value="04" <?php echo $_POST['aw_award_date_'.$i.'_month']=='04'?' selected="selected"':''; ?>>Apr</option>
											<option value="05" <?php echo $_POST['aw_award_date_'.$i.'_month']=='05'?' selected="selected"':''; ?>>May</option>
											<option value="06" <?php echo $_POST['aw_award_date_'.$i.'_month']=='06'?' selected="selected"':''; ?>>Jun</option>
											<option value="07" <?php echo $_POST['aw_award_date_'.$i.'_month']=='07'?' selected="selected"':''; ?>>Jul</option>
											<option value="08" <?php echo $_POST['aw_award_date_'.$i.'_month']=='08'?' selected="selected"':''; ?>>Aug</option>
											<option value="09" <?php echo $_POST['aw_award_date_'.$i.'_month']=='09'?' selected="selected"':''; ?>>Sep</option>
											<option value="10" <?php echo $_POST['aw_award_date_'.$i.'_month']=='10'?' selected="selected"':''; ?>>Oct</option>
											<option value="11" <?php echo $_POST['aw_award_date_'.$i.'_month']=='11'?' selected="selected"':''; ?>>Nov</option>
											<option value="12" <?php echo $_POST['aw_award_date_'.$i.'_month']=='12'?' selected="selected"':''; ?>>Dec</option>
											</select>
										</div>
										<div class="col-4">
											<input type="text" name="aw_award_date_<?php echo $i; ?>_year" id="aw_award_date_<?php echo $i; ?>_year" class="form-control" value="<?php echo $_POST['aw_award_date_'.$i.'_year']; ?>" tabindex="<?php echo $tab++; ?>">									
										</div>
									</div>
								</div>
								<div class="col-md-2">									
								...
								<div class="col-md-1">									
									...
									<?php
									if ($_POST['aw_attachment_'.$i]!='') {
										echo fileExists_img_link($_POST['aw_attachment_'.$i], 'aw_attachment_'.$i);
									}
									?>									
								</div>
								<div class="col-md-1 d-flex justify-content- align-items-center">
							...
							<div id="add_rows_length_ci" class="row">
								...
								<div class="col-md-3">
									...
									<div class="row">
										<div class="col-4">
											<select name="ci_date_<?php echo $i; ?>_month" id="ci_date_<?php echo $i; ?>_month" class="form-control" tabindex="<?php echo $tab++; ?>">
											<option value="01" <?php echo $_POST['ci_date_'.$i.'_month']=='01'?' selected="selected"':''; ?>>Jan</option>
											<option value="02" <?php echo $_POST['ci_date_'.$i.'_month']=='02'?' selected="selected"':''; ?>>Feb</option>
											<option value="03" <?php echo $_POST['ci_date_'.$i.'_month']=='03'?' selected="selected"':''; ?>>Mar</option>
											<option value="04" <?php echo $_POST['ci_date_'.$i.'_month']=='04'?' selected="selected"':''; ?>>Apr</option>
											<option value="05" <?php echo $_POST['ci_date_'.$i.'_month']=='05'?' selected="selected"':''; ?>>May</option>
											<option value="06" <?php echo $_POST['ci_date_'.$i.'_month']=='06'?' selected="selected"':''; ?>>Jun</option>
											<option value="07" <?php echo $_POST['ci_date_'.$i.'_month']=='07'?' selected="selected"':''; ?>>Jul</option>
											<option value="08" <?php echo $_POST['ci_date_'.$i.'_month']=='08'?' selected="selected"':''; ?>>Aug</option>
											<option value="09" <?php echo $_POST['ci_date_'.$i.'_month']=='09'?' selected="selected"':''; ?>>Sep</option>
											<option value="10" <?php echo $_POST['ci_date_'.$i.'_month']=='10'?' selected="selected"':''; ?>>Oct</option>
											<option value="11" <?php echo $_POST['ci_date_'.$i.'_month']=='11'?' selected="selected"':''; ?>>Nov</option>
											<option value="12" <?php echo $_POST['ci_date_'.$i.'_month']=='12'?' selected="selected"':''; ?>>Dec</option>
											</select>
										</div>
										<div class="col-4">
											<input type="text" name="ci_date_<?php echo $i; ?>_year" id="ci_date_<?php echo $i; ?>_year" class="form-control" value="<?php echo $_POST['ci_date_'.$i.'_year']; ?>" tabindex="<?php echo $tab++; ?>">									
										</div>
									</div>							
								</div>
								<div class="col-md-2">									
									...
									<?php
									if ($_POST['ci_attachment_'.$i]!='') {
										echo fileExists_img_link($_POST['ci_attachment_'.$i], 'ci_attachment_'.$i);
									}											
									?>									
								</div>
							...
							<div id="add_rows_length_ti" class="row">
								...
								<div class="col-md-2">									
									...
									<div class="row">
										<div class="col-4">
											<select name="ti_date_<?php echo $i; ?>_month" id="ti_date_<?php echo $i; ?>_month" class="form-control" tabindex="<?php echo $tab++; ?>">
											<option value="01" <?php echo $_POST['ti_date_'.$i.'_month']=='01'?' selected="selected"':''; ?>>Jan</option>
											<option value="02" <?php echo $_POST['ti_date_'.$i.'_month']=='02'?' selected="selected"':''; ?>>Feb</option>
											<option value="03" <?php echo $_POST['ti_date_'.$i.'_month']=='03'?' selected="selected"':''; ?>>Mar</option>
											<option value="04" <?php echo $_POST['ti_date_'.$i.'_month']=='04'?' selected="selected"':''; ?>>Apr</option>
											<option value="05" <?php echo $_POST['ti_date_'.$i.'_month']=='05'?' selected="selected"':''; ?>>May</option>
											<option value="06" <?php echo $_POST['ti_date_'.$i.'_month']=='06'?' selected="selected"':''; ?>>Jun</option>
											<option value="07" <?php echo $_POST['ti_date_'.$i.'_month']=='07'?' selected="selected"':''; ?>>Jul</option>
											<option value="08" <?php echo $_POST['ti_date_'.$i.'_month']=='08'?' selected="selected"':''; ?>>Aug</option>
											<option value="09" <?php echo $_POST['ti_date_'.$i.'_month']=='09'?' selected="selected"':''; ?>>Sep</option>
											<option value="10" <?php echo $_POST['ti_date_'.$i.'_month']=='10'?' selected="selected"':''; ?>>Oct</option>
											<option value="11" <?php echo $_POST['ti_date_'.$i.'_month']=='11'?' selected="selected"':''; ?>>Nov</option>
											<option value="12" <?php echo $_POST['ti_date_'.$i.'_month']=='12'?' selected="selected"':''; ?>>Dec</option>
											</select>
										</div>
										<div class="col-4">
											<input type="text" name="ti_date_<?php echo $i; ?>_year" id="ti_date_<?php echo $i; ?>_year" class="form-control" value="<?php echo $_POST['ci_date_'.$i.'_year']; ?>" tabindex="<?php echo $tab++; ?>">									
										</div>
									</div>									
								</div>
								<div class="col-md-2">									
								...
								<div class="col-md-2">									
									...
									<?php
									if ($_POST['ti_attachment_'.$i]!='') {
										echo fileExists_img_link($_POST['ti_attachment_'.$i], 'ti_attachment_'.$i);
									}					
									?>								
								</div>
							...
							<div id="add_rows_length_rc" class="row">
								...
								<div class="col-md-2">									
									...
									<?php
									if ($_POST['rc_attachment_'.$i]!='') {
										echo fileExists_img_link($_POST['rc_attachment_'.$i], 'rc_attachment_'.$i);
									}											
									?>
								</div>
							...
							<div id="add_rows_length_rg" class="row">
								...
								<div class="col-md-2">									
									...
									<textarea name="rg_topic_<?php echo $i; ?>" id="rg_topic_<?php echo $i; ?>" class="form-control" placeholder=" " tabindex="<?php echo $tab++; ?>"><?php echo $_POST['rg_topic_'.$i]; ?></textarea>
								</div>
								<div class="col-md-2">									
									<label >Date of Registration</label>
									<div class="row">
										<div class="col-4">
											<select name="rg_date_<?php echo $i; ?>_month" id="rg_date_<?php echo $i; ?>_month" class="form-control" tabindex="<?php echo $tab++; ?>">
											<option value="01" <?php echo $_POST['rg_date_'.$i.'_month']=='01'?' selected="selected"':''; ?>>Jan</option>
											<option value="02" <?php echo $_POST['rg_date_'.$i.'_month']=='02'?' selected="selected"':''; ?>>Feb</option>
											<option value="03" <?php echo $_POST['rg_date_'.$i.'_month']=='03'?' selected="selected"':''; ?>>Mar</option>
											<option value="04" <?php echo $_POST['rg_date_'.$i.'_month']=='04'?' selected="selected"':''; ?>>Apr</option>
											<option value="05" <?php echo $_POST['rg_date_'.$i.'_month']=='05'?' selected="selected"':''; ?>>May</option>
											<option value="06" <?php echo $_POST['rg_date_'.$i.'_month']=='06'?' selected="selected"':''; ?>>Jun</option>
											<option value="07" <?php echo $_POST['rg_date_'.$i.'_month']=='07'?' selected="selected"':''; ?>>Jul</option>
											<option value="08" <?php echo $_POST['rg_date_'.$i.'_month']=='08'?' selected="selected"':''; ?>>Aug</option>
											<option value="09" <?php echo $_POST['rg_date_'.$i.'_month']=='09'?' selected="selected"':''; ?>>Sep</option>
											<option value="10" <?php echo $_POST['rg_date_'.$i.'_month']=='10'?' selected="selected"':''; ?>>Oct</option>
											<option value="11" <?php echo $_POST['rg_date_'.$i.'_month']=='11'?' selected="selected"':''; ?>>Nov</option>
											<option value="12" <?php echo $_POST['rg_date_'.$i.'_month']=='12'?' selected="selected"':''; ?>>Dec</option>
											</select>
										</div>
										<div class="col-4">
											<input type="text" name="rg_date_<?php echo $i; ?>_year" id="rg_date_<?php echo $i; ?>_year" class="form-control" value="<?php echo $_POST['rg_date_'.$i.'_year']; ?>" tabindex="<?php echo $tab++; ?>">									
										</div>
									</div>
								...
								<div class="col-md-2">									
									...
									<select name="rg_status_<?php echo $i; ?>" id="rg_status_<?php echo $i; ?>" tabindex="<?php echo $tab++; ?>" class="form-control">
										...
										<option value="pending" <?php echo $_POST['rg_status_'.$i]=='pending'?' selected':'';?>>In-progress</option>
									</select>																		
								</div>
								<div class="col-md-2">									
									<label >Attachement</label>
									...
									<?php
									if ($_POST['rg_attachment_'.$i]!='') {
										echo fileExists_img_link($_POST['rg_attachment_'.$i], 'rg_attachment_'.$i);
									}											
									?>								
								</div>
					...
					<?php
						if($_POST['status']=='1'){
							...
							echo '&nbsp;<a href="digital_profile_print.php" target="_blank"><button type="button" name="print_data" id="print_data" class="btn btn-warning">Print Digital Profile</button></a>';
						}
						else{
...
<script>	
	...
	function add_rows_aw(){
		...
		var txt = id+'<div id="add_rows_length_aw" class="row"><div class="col-md-2"><label >Award Title</label><input type="text" name="aw_award_title_'+id+'" id="aw_award_title_'+id+'" class="form-control" placeholder=" " value=""></div><div class="col-md-2"><label >Awardee Bodies</label><input type="text" name="aw_awardee_bodie_'+id+'" id="aw_awardee_bodie_'+id+'" class="form-control" placeholder=" " value=""></div><div class="col-md-2"><label >Category</label><select name="aw_category_'+id+'" id="aw_category_'+id+'" tabindex="104" class="form-control"><option value="">--- Select ---</option><option value="1">Social</option><option value="2">State</option><option value="3">National</option><option value="4">International</option></select></div><div class="col-md-2"><label >Date</label><div class="row"><div class="col-4"><select name="aw_award_date_'+id+'_month" id="aw_award_date_'+id+'_month" class="form-control"><option value="01">Jan</option><option value="02">Feb</option><option value="03">Mar</option><option value="04">Apr</option><option value="05">May</option><option value="06">Jun</option><option value="07">Jul</option><option value="08">Aug</option><option value="09">Sep</option><option value="10">Oct</option><option value="11">Nov</option><option value="12">Dec</option></select></div><div class="col-4"><input type="text" name="aw_award_date_'+id+'_year" id="aw_award_date_'+id+'_year" class="form-control"></div></div></div><div class="col-md-2"><label >Place</label><input type="text" name="aw_award_place_'+id+'" id="aw_award_place_'+id+'" class="form-control"></div><div class="col-md-1"><input type="file" name="aw_award_place_'+id+'" id="aw_award_place_'+id+'" class="form-control" placeholder=" " value="" ></div><div class="col-md-1 d-flex justify-content- align-items-center"><button type="button" id="add_button_aw" class="btn btn-info pull-right" onClick="add_rows_aw()">Add</button></div></div>';
		$("#test_aw").append(txt);
	...
	function add_rows_rg(){
		...
		var txt = id+'<div id="add_rows_length_rg" class="row"><div class="col-md-3"><label >Name of Scholar</label><input type="text" name="rg_name_of_scholar_'+id+'" id="rg_name_of_scholar_'+id+'" class="form-control" placeholder=" " value="" ></div><div class="col-md-2"><label >Topic of Research</label><textarea name="rg_topic_'+id+'" id="rg_topic_'+id+'" class="form-control" placeholder=" " value="" ></textarea></div><div class="col-md-2"><label >Date of Registration</label><div class="row"><div class="col-4"><select name="rg_date_'+id+'_month" id="rg_date_'+id+'_month" class="form-control"><option value="01">Jan</option><option value="02">Feb</option><option value="03">Mar</option><option value="04">Apr</option><option value="05">May</option><option value="06">Jun</option><option value="07">Jul</option><option value="08">Aug</option><option value="09">Sep</option><option value="10">Oct</option><option value="11">Nov</option><option value="12">Dec</option></select></div><div class="col-4"><input type="text" name="rg_date_'+id+'_year" id="rg_date_'+id+'_year" class="form-control"></div></div></div><div class="col-md-2"><label>Status</label><select name="rg_status_'+id+'" id="rg_status_'+id+'" class="form-control"><option value="">--Select--</option><option value="awarded">Awarded</option><option value="pending">Pending</option></select></div><div class="col-md-2"><label >Attachement</label><input type="file" name="rg_attachment_'+id+'" id="rg_attachment_'+id+'" class="form-control" placeholder=" " value=""></div><div class="col-md-1 d-flex justify-content- align-items-center"><button type="button" id="add_button_rg" class="btn btn-info pull-right" onClick="add_rows_rg()">Add</button></div></div>';
		$("#test_rg").append(txt);
