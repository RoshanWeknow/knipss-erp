...
<body id="public">
	<div id="wrapper">	
        ...
        <li class="notranslate"><label  class="desc" for="opt_minor">Physical Handicapped <span class="alert">*</span></label>
        <?php echo $_POST['physical_handicapped']; ?>
        <input type="hidden" name="physical_handicapped" value="<?php echo $_POST['physical_handicapped']; ?>">
        </li>
        ...
        <input type="hidden" name="s_class" value="<?php echo $_POST['s_class']; ?>">
       	...
       	<li class="notranslate"><label  class="desc" for="s_class">Batch<span class="alert">*</span></label>
        <?php echo $_POST['batch']; ?>
      ...
      <li class="notranslate"><label  class="desc" for="m_name">Select subjects 2 <span class="alert">*</span></label>
