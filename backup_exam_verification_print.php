                ...
                <table width="100%" class="table table-bordered border border-dark">
                    ...
                    <tr>
                        ...
                        <th scope="col" width="20%" rowspan="8">
                            <?php echo $student_exam_info['exam_form_no']; ?><br><img
                                src="<?php echo $stu_student_info['photo_id']; ?>"
                                style="height:110px; width:110px; margin-right:10px;"><br><img
                                src="<?php echo $stu_student_info['signature_id']; ?>"
                                style="height:35px; width:110px; margin-right:10px;"><br><img
                                src="images/principal_sign.jpg"
