...
<?php	
    ...
    if(isset($_POST['edit']) && $_POST['edit'] != ''){
        ...
        $sql = 'UPDATE ag_lib_master_tray set  
			 ...
			 //echo $sql;		 
				...
				$sql = 'INSERT INTO ag_lib_master_tray(almirah_name, tray_name, max_quantity, created_by, creation_time) 
	...
	if(isset($_GET['del'])){
		...
		$sql = 'delete from ag_lib_master_tray where sno="'.$_GET['del'].'"';
	...
	$sql = 'select * from ag_lib_master_tray where sno = '.$_GET['edit'];
						...
						<tr>
							...
							<th><select class="form-control" name="almirah_name" id="almirah_name" class="form-control">
									...
									<?php
										...
										$sql = "SELECT * FROM ag_lib_master_almirah";
					...
					<table width="80%" class="table table-striped  table-hover rounded">
						...
						<tr class="bg-primary text-white">
							...
							<?php
								...
								$sql = 'select * from ag_lib_master_tray';
								...
								while($row = mysqli_fetch_assoc($result)){
									...
									<td><a href="ag_lib_master_tray.php?edit='.$row['sno'].'" onClick="return confirm(\'Are you sure? \');" <h3 style="color: #3066ec;"> Edit</h3></a></td>

									<td><a href="ag_lib_master_tray.php?del='.$row['sno'].'" onClick="return confirm(\'Are you sure? \');" <h3 style="color:red;"></h3>Delete</a></td>
