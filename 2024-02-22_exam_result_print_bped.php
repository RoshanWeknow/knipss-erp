		...
		?>
            ...
            <table class="table text-center" width="100%" style="border:1px solid black; ">
					...
					<?php
							if($row4['theory_practical']=="Theory"){
								if(!isset($paper_type_show_theory)){
									...
									if($_POST['result_course']==245){
										$paper_type_show_theory = $row4['theory_practical'];
									echo '<tr style="border:1px solid black; "><th width="55%" class="abc text-start">Subject / Paper Selected <br>(THEORY)<span style="margin-left:200px;">Max/Min</span> </th> <th  width="15%" class="abc ">Th.<br>'.$a1.'/'.$a2.'</th> <th  width="15%" class="abc ">Assign.<br>'.$b1.'/'.$b2.'</th><th  width="15%" class="abc " > Total<br>'.$c1.'/'.$c2.'</th></tr>';
							...
							if($row4['theory_practical']=="Practical"){
								if(!isset($paper_type_show_th_sum)){
									...
									echo '<tr style="border:1px solid black; "> <td class="abc text-start" ><b>THEORY TOTAL <span style="margin-left:100px;"> Max.'.$d.'&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;Min.'.$e.'</span></b></td><th>'.$tot_theory_marks_obt.'</th>  <th>'.$tot_mid_marks_obt.'</th>  <td class="abc text-end" colspan="1" ><b>'.$theroy_sum.'&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;</b></td></tr>';
								}
						...
						if($inc == $row_num){
							if($row4['theory_practical']=="Practical"){
								if(!isset($paper_type_show_pt_sum)){
									...
									$paper_type_show_pt_sum = "pt_sum";
										echo '<tr style="border:1px solid black; " ><th  class="abc text-start" colspan="3"><span style="font-size:12px;">PRACTICAL ACTIVITIES /VIVA-VOCE</span><span style="margin-left:10px;">Max.'.$h1.'&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;Min.'.$h2.'</span> </th> <th   class="abc "  >'.$prac_sum.'&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; </th></tr>';
									}
									else if($_POST['result_course']==87){
									$paper_type_show_pt_sum = "pt_sum";
										echo '<tr style="border:1px solid black; " ><th  class="abc text-start" colspan="3"><span style="font-size:12px;">PRACTICAL ACTIVITIES /VIVA-VOCE</span><span style="margin-left:10px;">Max.'.$h1.'&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;Min.'.$h2.'</span> </th> <th   class="abc "  >'.$prac_sum.'&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; </th></tr>';
				...
				<tr  style="border:1px solid black; " >
                    ...
                    <th  class="text-center"   style="border:1px solid black; " colspan="3"> <br> <?php echo $tot_obt; ?><br><?php echo '( '.strtoupper(int_to_words($tot_obt)).' )';?></th>
                </tr>
				<tr  style="border:1px solid black; " >
                    <th  class=" p-2 text-start"  style="border:1px solid black; ">
						<table width="100%">
							<tr >
								...
								<td width="50%" class="note">Theory<br>Practical & viva-voce</td>
							</tr>
						</table>
					</th>
                    <th  class="text-center"   style="border:1px solid black; ">Grand Total <br><?php echo $theroy_sum ?> / <?php echo $theory_max_sum ?><br><?php echo $prac_sum ?> / <?php echo $prac_max_sum ?></th>
                    ...
                    <th  class=" p-2 text-start"  style="border:1px solid black; ">
						<table width="100%">
							<tr >
								<td width="30%" class="note"><span style="font-size:11px;">MAX MARKS <br>MARKS OBTAINED</span></td>
								<th width="20%"><span style="font-size:17px;">RESULT</span></th>
								<th width="50%" class="note"><span style="margin-top:5px!important;">Theory<br>Practical & viva-voce</span></th>
							</tr>
						</table>
					</th>
                    <th  class="text-center"   style="border:1px solid black; ">Grand Total <br><?php echo $theroy_sum ?> / <?php echo $theory_max_sum ?><br><?php echo $prac_sum ?> / <?php echo $prac_max_sum ?></th>
			...
			<?php if($_POST['result_course']==107){ ?>
				<tr>
					<th>RESULT DECLARATION DATE : 21-02-2024</th>
				</tr>
				<tr>
					<th>NOTE :</th>
				</tr>
