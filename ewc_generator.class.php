...
class EWCGenerator
{
	...
	public function initialize($options)
	{
		if($options['file_name']!=''){
			$this->_options['file_name'] = $options['file_name'];
		}
		else{
			$this->_options['file_name'] = $this->_options['file_name'];
		}
		if($options['extension']!=''){
			$this->_options['extension'] = $options['extension'];
		}
		else{
			$this->_options['extension'] = $this->_options['extension'];
		}
		if($options['hasHTML']!=''){
			$this->_options['hasHTML'] = $options['hasHTML'];
		}
		else{
			$this->_options['hasHTML'] = $this->_options['hasHTML'];
		}
		if($options['document']!=''){
			$this->_options['document'] = $options['document'];
		}
		else{
			$this->_options['document'] = $this->_options['document'];
		}
		...
		if (is_array($array)) {
			if($options['title']['content']!=''){
				$this->_options['title']['content'] = $options['title']['content'];
			}
			else{
				$this->_options['title']['content'] = $this->_options['title']['content'];
			}
			if($options['title']['align']!=''){
				$this->_options['title']['align'] = $options['title']['align'];
			}
			else{
				$this->_options['title']['align'] = $this->_options['title']['align'];
			}
			if($options['title']['active']!=''){
				$this->_options['title']['active'] = $options['title']['active'];
			}
			else{
				$this->_options['title']['active'] = $this->_options['title']['active'];
			}
