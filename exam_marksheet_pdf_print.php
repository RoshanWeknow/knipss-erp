...
$sql = 'select * from exam_student_info where course_name="'.$_GET['id'].'"  and exam_roll_no is not null and exam_roll_no!="" order by abs(exam_roll_no) limit '.$_GET['s'].', '.$_GET['c'];
//echo $sql;
                ...
                <table width="100%" class="table table-bordered border border-dark">
                    ...
                    <tr>
                        ...
                        <th scope="col" width="20%" rowspan="8">
                            ...
                            <?php if($class['semester']=="1"){?>
                            <img src="PHOTO/<?php echo $stu_student_info['photo_id']; ?>" style="height:110px; width:110px; margin-right:10px;"><br>
                            <img src="PHOTO/<?php echo  $stu_student_info['signature_id']; ?>"   style="height:35px; width:110px; margin-right:10px;">
                             <?php }else{ ?>
