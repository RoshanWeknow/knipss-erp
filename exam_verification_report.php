        ...
        <div class="row">
            <div class="col-md-3">
                ...
                <select id="class_filter" name="class_filter" class="form-control">
                    ...
                    <?php
                    $class_query = 'SELECT * FROM class_detail WHERE semester IN ("1", "3") ORDER BY ABS(group_short) ASC';
            ...
            <div class="col-md-3">
                ...
                <select id="verify_status" name="verify_status" class="form-control">
                    ...
                    <option value="1" <?= (isset($_POST['verify_status']) && $_POST['verify_status'] === '1') ? 'selected' : '' ?>>Verified</option>
                    <option value="0" <?= (isset($_POST['verify_status']) && $_POST['verify_status'] === '0') ? 'selected' : '' ?>>Not Verified</option>
                </select>
            </div>
        ...
        <table class="table table-striped table-hover table-bordered" id="general_stat_table">
            ...
            <tbody>
                ...
                if (!empty($_POST['exam_name'])) {
                    $sql1 .= ' AND exam_id="'.mysqli_real_escape_string($db, $_POST['exam_name']).'"';
                }

                if (!empty($_POST['class_filter'])) {
                    $sql1 .= ' AND course_name="'.mysqli_real_escape_string($db, $_POST['class_filter']).'"';
                }

                if (isset($_POST['verify_status']) && $_POST['verify_status'] !== '') {
                    $sql1 .= ' AND verify_status="'.mysqli_real_escape_string($db, $_POST['verify_status']).'"';
                }
