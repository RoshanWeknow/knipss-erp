            ...
            <div class="col-md-12">
                <div class="card">
					...
					$limit = 50;
							...
							$offset = ($page - 1) * $limit;
							$sql = "SELECT * FROM lib_id_card ORDER BY sno ASC LIMIT {$offset}, {$limit}";
						...
						<?php
									...
									while($row = mysqli_fetch_assoc($result)){
										...
										echo '<tr align="center">
											...
											<td>';
												if (isset($course['class_description']) && is_numeric($course['class_description'])) {
													echo $course['class_description'];
												} elseif (isset($row['course'])) {
													echo $row['course'];
												} else {
													echo 'N/A'; // or handle the case where both are null
												}

										echo '</td>
												<td>'.$row['valid_upto'].'</td>
												<td><a href="lib_card_result.php?id='.$row['sno'].'" target="_blank"><i class="fa fa-print" style="font-size:20px; color:red;"></i></a></td>
											</tr>';
