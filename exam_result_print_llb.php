            ...
            <table class="table text-center" width="100%" style="border:1px solid black; ">
				...
				<?php
					...
					<tr style="border:1px solid black;">
						...
						<td class="abc"><?php echo $min_marks = 36; ?></td>
				...
				<?php
						...
						if($row2['pt_marks_obt']<36){
							...
							$passing_status_reason .= "Marks less then 36";
						}
				...
				<tr style="border:1px solid black; ">
                    <td class="abc text-start"><b>Total : <?php
						if($total_obt == 0){
						echo "ABSENT";
					} else{
						echo strtoupper(int_to_words($total_obt));
					}
					?></b></td>
                    <td class="abc"><b><?php echo $total_max; ?></b></td>
                    <td class="abc"><b>315</b></td>
                    <td class="abc"><b><?php if($total_obt == 0){
						echo "Abs";
					} else{
						echo $total_obt;
					}
                    ...
                    <th  class=" p-2 text-start"  style="border:1px solid black; ">
						<?php
							$erp_23 = mysqli_connect("p:localhost", "root", "mysql","knipsser_2023");
								...
								$grant_total =$row_t2['obt_marks'] + $row_t['obt_marks'] + $total_obt;
								if($row_t['passing_status'] == "FAILED"|| $row_t['passing_status'] == "ATKT" || $row_t2['passing_status'] == "FAILED"|| $row_t2['passing_status'] == "ATKT" ){
									$passing_status ="INC";
								}else{
									$passing_status;
								}
								if($row_t['passing_status'] == "FAILED" || $row_t['passing_status'] == "ATKT" || $row_t2['passing_status'] == "FAILED" || $row_t2['passing_status'] == "ATKT"){
									...
									$grant_total_obt= $row_t2['obt_marks'] + $row_t['obt_marks'] + $total_obt;
									$grant_total_max=$row_t2['max_marks'] + $row_t['max_marks'] + $total_max;
								}
						...
						<table width ="100%">
							...
							<tr>
								<th>MAX MARKS</th>
								<th><?php echo $row_t['max_marks']; ?></th>
								<th><?php echo $row_t2['max_marks']; ?></th>
								<th><?php echo $total_max; ?></th>
							</tr>
							<tr>
								<th>MARKS OBTAINED</th>
								<th ><?php 
									...
									?></th>
									<th ><?php 
										if($row_t2['passing_status'] == "FAILED" || $row_t2['passing_status'] == "ATKT"){
											echo '-';
										}else{
											echo $row_t2['obt_marks'];
										}
									?></th>
								<th><?php if($total_obt == 0){
										echo "Abs";
