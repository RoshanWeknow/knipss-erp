...
<div class="row">
<h2 class="bg-secondary text-white text-center p-2 ">BACK FORM VERIFICATION REPORT</h2>
    <form method="POST">
        <div class="row">
            <!-- Date Filters and Exam Name Filter (already existing) -->
            ...
            <div class="col-md-3">
                ...
                <select id="class_filter" name="class_filter" class="form-control">
                    ...
                    <?php
                    $class_query = "SELECT * FROM class_detail where semester='1'";
...
function toggleVerifyStatus(studentId, newStatus) {
    ...
    if (confirm(confirmMessage)) {
        $.ajax({
            url: 'back_update_verify_status.php',
            type: 'POST',
            data: {
