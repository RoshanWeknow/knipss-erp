		...
		<div class="card-body ">
			<div class="row d-flex my-auto">
				<form action="new_admission.php" class="wufoo leftLabel page1" name="admission" enctype="multipart/form-data" method="post">
					...
					<h2 align="center">Application Form For <span class="orange">Admission (<?php echo $session_val['value']?>)</span></h2>	
					<?php echo $msg;
					//print_r($_POST); ?>
					<?php
					 if($_SESSION['username']=='sadmin') {
					...
					<div class="col-md-12">
						<div class="row">							
							<div class="col-md-4">							
								...
								<input type="date " name="" value="<?php if(isset($_POST['doa'])){echo $_POST['doa'];}else{echo date("Y-m-d");} ?>">
							</div>
							<div class="col-md-4">							
								<label>Select class <span class="alert">*</span></label>
								<select name="s_class" class="listmenu" id="s_class"  value="<?php if(isset($_POST['s_class'])){echo $_POST['s_class'];} ?>" onChange="get_subject(this.value)" onFocus="fnTXTFocus(this.id)" >
							...
							<div class="col-md-4">							
								<label>Batch</label>
								<input type="text" id="batch" name="batch" value="<?php if(isset($_POST['batch'])){echo $_POST['batch'];} ?>">
							</div>
						</div>
						<div class="row">							
							<div class="col-md-4">							
								<label>Select subjects <span class="alert">*</span></label>
								<select name="sub1"   class="listmenu" id="sub1"  value="<?php if(isset($_POST['sub1'])){echo $_POST['sub1'];} ?>" onFocus="fnTXTFocus(this.id)"><option value=""></option></select>
								2).&nbsp;<select name="sub2"   class="listmenu" id="sub2"  value="<?php if(isset($_POST['sub2'])){echo $_POST['sub2'];} ?>" onFocus="fnTXTFocus(this.id)"><option value=""></option></select>					
									3).&nbsp;<select name="sub3"  class="listmenu" id="sub3"  value="<?php if(isset($_POST['sub3'])){echo $_POST['sub3'];} ?>" onFocus="fnTXTFocus(this.id)"><option value=""></option></select>
							</div>
							<div class="col-md-4">							
								<label>Minor/Elective:</label>
								<select name="other_sub1"  value="" class="listmenu" id="other_sub1" onFocus="fnTXTFocus(this.id)">
							...
							<div class="col-md-4">							
								...
								<select name="other_sub2"  value="" class="listmenu" id="other_sub2" onFocus="fnTXTFocus(this.id)">
						...
						<div class="row">							
							<div class="col-md-4">							
								...
								<select name="other_sub3"  value="" class="listmenu" id="other_sub3" onFocus="fnTXTFocus(this.id)">
							...
							<div class="col-md-4">							
								...
								<input class="fieldtextmedium"  type="text" id="tax11" maxlength="10" size="10" name="form_no" value="<?php if(isset($_POST['form_no'])){echo $_POST['form_no'];} ?>" onFocus="fnTXTFocus(this.id)" />
							</div>
							<div class="col-md-4">							
								<label>Candidate's Full Name <span class="alert">*</span></label>
								<input class="fieldtextmedium"  id="s_name" maxlength="45" size="40" value="<?php if(isset($_POST['s_name'])){echo $_POST['s_name'];} ?>"  name="s_name" onFocus="fnTXTFocus(this.id)" >
							</div>
						</div>
						<div class="row">							
							<div class="col-md-4">							
								<label>Father's Name<span class="alert">*</span></label>
								<input class="fieldtextmedium" id="f_name" maxlength="35" size="40" name="f_name" value="<?php if(isset($_POST['f_name'])){echo $_POST['f_name'];} ?>" onFocus="fnTXTFocus(this.id)" >
							</div>
							<div class="col-md-4">							
								<label>Mother's Name <span class="alert">*</span></label>
								<input class="fieldtextmedium" id="m_name" maxlength="35" size="40" name="m_name"  value="<?php if(isset($_POST['m_name'])){echo $_POST['m_name'];} ?>" onFocus="fnTXTFocus(this.id)" >
							</div>
							<div class="col-md-4">							
								<label>Date of Birth<span class="name">*</span></label>
								<input type="date " name="dob" value="<?php if(isset($_POST['dob'])){echo $_POST['dob'];}else{echo date("Y-m-d");} ?>">
							</div>
						</div>
						<div class="row">							
							<div class="col-md-4">							
								<label>Gender <span class="alert">*</span></label>
								<select class="listMenu" name="gen" id="gen" value="<?php if(isset($_POST['gen'])){echo $_POST['gen'];} ?>" onFocus="fnTXTFocus(this.id)">
           ...
           <li class="notranslate"><label  class="desc" for="m_name">Mother's Name <span class="alert">*</span></label>
                ...
                <div>
                 ...
                 <div><select class="listMenu" name="opt_minor" id="opt_minor"   value="<?php if(isset($_POST['opt_minor'])){echo $_POST['opt_minor'];} ?>" onChange="changefees1(this.value)" onFocus="fnTXTFocus(this.id)">
				  ...
				  <li class="notranslate"><label  class="desc" for="opt_cat">Physical Handicapped <span class="alert">*</span></label>
					  <div><select name="physical_handicapped" value="">
                 ...
                 <div><select name="prev_univ" class="listmenu" id="prev_univ"  value="<?php if(isset($_POST['prev_univ'])){echo $_POST['prev_univ'];} ?>" onFocus="fnTXTFocus(this.id)" >
                  ...
                  <li class="notranslate" id="fees"><label  class="desc" for="fees" >Fees<span class="alert">*</span></label>
                <div><input class="fieldtextmedium" maxlength="15" size="20" name="fees" id="final_fees_value"  value="<?php if(isset($_POST['fees'])){echo $_POST['fees'];} ?>" onFocus="fnTXTFocus(this.id)" >
            </div></li>
            
            	<li class="notranslate" id="fees_detail" style="display: none;">
             		<label  class="desc" for="fees" >Fees Details<span class="alert">*</span></label>
              		<div><table>
              			<tr>
              				<td>Fees : </td>
              				<td id="fees_value"></td>
                 ...
                 <li class="notranslate" id="computer"><label  class="desc" for="computer">Computer Fees<span class="alert">*</span></label>
                <div><input class="fieldtextmedium" type="checkbox" id="tax11" maxlength="10" size="10" name="computer" onFocus="fnTXTFocus(this.id)"
                 <?php if(isset($_POST['computer'])) echo 'checked="checked"';  ?> />
             </div></li>
             <li class="notranslate" id="self"><label  class="desc" for="self">Self Fees<span class="alert">*</span></label>
                <div><input class="fieldtextmedium" type="checkbox" id="tax11" maxlength="10" size="10" name="self" onFocus="fnTXTFocus(this.id)" <?php if(isset($_POST['self'])) echo 'checked="checked"';  ?> />
             </div></li>
             <li class="notranslate" id="tour"><label  class="desc" for="tour">Tour Fees<span class="alert">*</span></label>
                <div><input class="fieldtextmedium" type="checkbox" <?php echo $tour_sel;?> id="tax11" maxlength="10" size="10" name="tour" onFocus="fnTXTFocus(this.id)" <?php if(isset($_POST['tour'])) echo 'checked="checked"';  ?> />
             </div></li>
             <li class="notranslate" id="vocational"><label  class="desc" for="tour">Vocational Fees<span class="alert">*</span></label>
                <div><input class="fieldtextmedium" type="checkbox" <?php echo $vocational;?> id="tax11" maxlength="10" size="10" name="vocational" onFocus="fnTXTFocus(this.id)" <?php if(isset($_POST['vocational'])) echo 'checked="checked"';  ?> />
             </div></li>
