					...
					<div class="bg-primary text-white p-2"><h3>Library Card</h3></div>
						...
						<table width="100%" class="table table-striped table-hover rounded">
							...
							<tr>	
								<th>Course</th>
								<td>
								   <input type="hidden" class="form-control" name="course_enrolled" value="<?php echo $course_enrolled; ?>">
								   <input type="text" class="form-control" name="course_enrolled1" value="<?php echo $course_enrolled1; ?>" required  > 
								</td>
								<th>Session</th>
								<td>
