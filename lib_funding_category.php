...
<?php	
    ...
    if(isset($_POST['edit']) && $_POST['edit'] != ''){
        $sql = 'UPDATE lib_funding_category set 
			 ...
			 //echo $sql;		 
				...
				$sql = 'INSERT INTO lib_funding_category(funding_source, created_by, created_date) 
					values("'.$_POST['funding_source'].'",
					"'.$_SESSION['username'].'",
					"'.date("d-m-y H:i:s").'")';
			//echo $sql;
	...
	if(isset($_GET['del'])){
		$sql = 'delete from lib_funding_category where sno="'.$_GET['del'].'"';
		mysqli_query($db, $sql);
		if(mysqli_error($db)){
	...
	if(isset($_GET['edit'])){
	$sql = 'select * from lib_funding_category where sno = '.$_GET['edit'];
	...
	<div class="card">
		<div class="card-body ">
			<div class="row d-flex my-auto">
				...
				<div class="bg-primary text-white p-2"><h3>Funding Source</h3></div>
					<table width="100%" class="table table-striped table-hover rounded">
						<tr>
							
							<th>Funding Source</th>
							<th><input type="text" name="funding_source" id="funding_source" value="<?php echo isset($_GET['edit'])? $res['funding_source']: '' ?>" class="form-control" required="required"></th>
							<th width="70%"></th>
						</tr>
					</table>
				...
				<div class="col-md-12" >
					<table width="80%" class="table table-striped  table-hover rounded">
						<tr class="bg-primary text-white">
							...
							<?php
								$sql = 'select * from lib_funding_category';
								...
								while($row = mysqli_fetch_assoc($result)){
									...
									<td><a href="lib_funding_category.php?edit='.$row['sno'].'" onClick="return confirm(\'Are you sure? \');" <h3 style="color: #3066ec;"> Edit</h3></a></td>
									<td><a href="lib_funding_category.php?del='.$row['sno'].'" onClick="return confirm(\'Are you sure? \');" <h3 style="color:red;"></h3>Delete</a></td>
										</tr>'	;
								}
							?>
					</table>
