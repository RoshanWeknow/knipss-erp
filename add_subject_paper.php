						...
						<table width="100%" class="table table-striped table-hover rounded">
							...
							<tr>
								...
								<th><select name="optional_group" id="optional_group" class="form-control" >
										...
										<option value="Optional-1" >Optional Group 1</option>
										<option value="Optional-2" >Optional Group 2</option>
										<option value="Optional-3" >Optional Group 3</option>
										<option value="Optional-4" >Optional Group 4</option>
										<option value="Optional-5" >Optional Group 5</option>
			...
			<div class="form-group mb-3">
				<div class="col-md-4">
					...
					<select name="class_id" id="class_filter" class="form-control" onchange="this.form.submit()">
						...
						<?php
							$sql_classes = 'SELECT * FROM class_detail where semester IN ("1","2","3","4") order by semester';
